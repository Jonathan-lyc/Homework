...
public class SortObject implements Comparable<SortObject> {
    ...
    public int compareTo(SortObject other) {
        ...
        else if (data < other.data) return -1;
        else                        return 1;
    }
