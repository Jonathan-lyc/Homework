...
print ver,subver,res1,res2,pad1,pad2,msglen
if ver != 1:
    print "Wrong version!"
    sys.exit(0)
...
if len(plaintextWithPad[16:]) - 32 < msglen:
    ############# DDDDDDDDDDDDDDDDDDDUUUUUUUUUUUUUUUUUUUUHHHHHHHHHHHHHHHHHHHHHHHH####################
    # Reorder, able to print out everything.
    try:
        print "Length of ", str(msglen).decode("hex"), "is too large!"
    except TypeError:
        pass
    sys.exit(0)
