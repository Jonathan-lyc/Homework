...
main (int argc, char* argv[]) {
  ...
  18:	e8 83 03 00 00       	call   3a0 <printf>
	exit();
  1d:	e8 36 02 00 00       	call   258 <exit>
  22:	90                   	nop
  23:	90                   	nop
  24:	90                   	nop
  25:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 32a:	f7 f7                	div    %edi
 32c:	0f b6 92 2b 07 00 00 	movzbl 0x72b(%edx),%edx
...
putc(int fd, char c)
{
 ...
 4d8:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 4db:	b9 24 07 00 00       	mov    $0x724,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 61b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 61d:	a3 44 07 00 00       	mov    %eax,0x744
}
 622:	5b                   	pop    %ebx
 623:	5e                   	pop    %esi
 624:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 66c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 670:	3b 05 44 07 00 00    	cmp    0x744,%eax
 ...
 68f:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 692:	89 0d 44 07 00 00    	mov    %ecx,0x744
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 6d2:	e8 c9 fe ff ff       	call   5a0 <free>
  return freep;
 6d7:	8b 0d 44 07 00 00    	mov    0x744,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6ec:	eb a4                	jmp    692 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6ee:	c7 05 44 07 00 00 3c 	movl   $0x73c,0x744
 6f5:	07 00 00 
    base.s.size = 0;
 6f8:	b9 3c 07 00 00       	mov    $0x73c,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6fd:	c7 05 3c 07 00 00 3c 	movl   $0x73c,0x73c
 704:	07 00 00 
    base.s.size = 0;
 707:	c7 05 40 07 00 00 00 	movl   $0x0,0x740
 70e:	00 00 00 
