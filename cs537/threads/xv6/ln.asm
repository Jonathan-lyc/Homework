...
main(int argc, char *argv[])
{
  ...
  13:	c7 44 24 04 ba 07 00 	movl   $0x7ba,0x4(%esp)
  1a:	00 
  ...
  5a:	c7 44 24 04 cd 07 00 	movl   $0x7cd,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37a:	f7 f7                	div    %edi
 37c:	0f b6 92 e8 07 00 00 	movzbl 0x7e8(%edx),%edx
...
putc(int fd, char c)
{
 ...
 5f0:	e9 30 fe ff ff       	jmp    425 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 5f5:	bf e1 07 00 00       	mov    $0x7e1,%edi
...
free(void *ap)
{
 ...
 601:	a1 04 08 00 00       	mov    0x804,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 64f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 651:	a3 04 08 00 00       	mov    %eax,0x804
}
 656:	5b                   	pop    %ebx
 657:	5e                   	pop    %esi
 658:	5f                   	pop    %edi
 ...
 67b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 67d:	a3 04 08 00 00       	mov    %eax,0x804
}
 682:	5b                   	pop    %ebx
 683:	5e                   	pop    %esi
 684:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 699:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 69c:	8b 0d 04 08 00 00    	mov    0x804,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6c8:	3b 05 04 08 00 00    	cmp    0x804,%eax
 ...
 6e7:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6ea:	89 0d 04 08 00 00    	mov    %ecx,0x804
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 72c:	e8 cf fe ff ff       	call   600 <free>
  return freep;
 731:	8b 0d 04 08 00 00    	mov    0x804,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 744:	eb a4                	jmp    6ea <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 746:	c7 05 04 08 00 00 fc 	movl   $0x7fc,0x804
 74d:	07 00 00 
    base.s.size = 0;
 750:	b9 fc 07 00 00       	mov    $0x7fc,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 755:	c7 05 fc 07 00 00 fc 	movl   $0x7fc,0x7fc
 75c:	07 00 00 
    base.s.size = 0;
 75f:	c7 05 00 08 00 00 00 	movl   $0x0,0x800
 766:	00 00 00 
