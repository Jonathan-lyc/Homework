...
main(int argc, char *argv[])
{
  ...
  13:	c7 44 24 04 c7 07 00 	movl   $0x7c7,0x4(%esp)
  1a:	00 
  ...
  5a:	c7 44 24 04 da 07 00 	movl   $0x7da,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37a:	f7 f7                	div    %edi
 37c:	0f b6 92 f5 07 00 00 	movzbl 0x7f5(%edx),%edx
...
putc(int fd, char c)
{
 ...
 528:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 52b:	b9 ee 07 00 00       	mov    $0x7ee,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 5f1:	a1 10 08 00 00       	mov    0x810,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 63f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 641:	a3 10 08 00 00       	mov    %eax,0x810
}
 646:	5b                   	pop    %ebx
 647:	5e                   	pop    %esi
 648:	5f                   	pop    %edi
 ...
 66b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 66d:	a3 10 08 00 00       	mov    %eax,0x810
}
 672:	5b                   	pop    %ebx
 673:	5e                   	pop    %esi
 674:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 689:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 68c:	8b 0d 10 08 00 00    	mov    0x810,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6c0:	3b 05 10 08 00 00    	cmp    0x810,%eax
 ...
 6df:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6e2:	89 0d 10 08 00 00    	mov    %ecx,0x810
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 722:	e8 c9 fe ff ff       	call   5f0 <free>
  return freep;
 727:	8b 0d 10 08 00 00    	mov    0x810,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 73c:	eb a4                	jmp    6e2 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 73e:	c7 05 10 08 00 00 08 	movl   $0x808,0x810
 745:	08 00 00 
    base.s.size = 0;
 748:	b9 08 08 00 00       	mov    $0x808,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 74d:	c7 05 08 08 00 00 08 	movl   $0x808,0x808
 754:	08 00 00 
    base.s.size = 0;
 757:	c7 05 0c 08 00 00 00 	movl   $0x0,0x80c
 75e:	00 00 00 
