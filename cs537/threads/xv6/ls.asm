...
fmtname(char *path)
{
  ...
  48:	c7 04 24 fc 0a 00 00 	movl   $0xafc,(%esp)
  ...
  63:	bb fc 0a 00 00       	mov    $0xafc,%ebx
  ...
  81:	00 
  82:	05 fc 0a 00 00       	add    $0xafc,%eax
...
ls(char *path)
{
 ...
 12d:	00 
 12e:	c7 44 24 04 c2 0a 00 	movl   $0xac2,0x4(%esp)
 135:	00 
 ...
 24d:	c7 44 24 04 c2 0a 00 	movl   $0xac2,0x4(%esp)
 254:	00 
 ...
 26a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_DIR:
    if(strlen(path) + 1 + DIRSIZ + 1 > sizeof buf){
      printf(1, "ls: path too long\n");
 270:	c7 44 24 04 cf 0a 00 	movl   $0xacf,0x4(%esp)
 277:	00 
 ...
 294:	c7 44 24 04 9a 0a 00 	movl   $0xa9a,0x4(%esp)
 29b:	00 
 ...
 2c2:	c7 44 24 04 ae 0a 00 	movl   $0xaae,0x4(%esp)
 2c9:	00 
 ...
 2e4:	c7 44 24 04 ae 0a 00 	movl   $0xaae,0x4(%esp)
 2eb:	00 
...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ls(".");
 348:	c7 04 24 e2 0a 00 00 	movl   $0xae2,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 65a:	f7 f7                	div    %edi
 65c:	0f b6 92 eb 0a 00 00 	movzbl 0xaeb(%edx),%edx
...
putc(int fd, char c)
{
 ...
 8d0:	e9 30 fe ff ff       	jmp    705 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 8d5:	bf e4 0a 00 00       	mov    $0xae4,%edi
...
free(void *ap)
{
 ...
 8e1:	a1 14 0b 00 00       	mov    0xb14,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 92f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 931:	a3 14 0b 00 00       	mov    %eax,0xb14
}
 936:	5b                   	pop    %ebx
 937:	5e                   	pop    %esi
 938:	5f                   	pop    %edi
 ...
 95b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 95d:	a3 14 0b 00 00       	mov    %eax,0xb14
}
 962:	5b                   	pop    %ebx
 963:	5e                   	pop    %esi
 964:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 979:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 97c:	8b 0d 14 0b 00 00    	mov    0xb14,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 9a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 9a8:	3b 05 14 0b 00 00    	cmp    0xb14,%eax
 ...
 9c7:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 9ca:	89 0d 14 0b 00 00    	mov    %ecx,0xb14
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 a0c:	e8 cf fe ff ff       	call   8e0 <free>
  return freep;
 a11:	8b 0d 14 0b 00 00    	mov    0xb14,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 a24:	eb a4                	jmp    9ca <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 a26:	c7 05 14 0b 00 00 0c 	movl   $0xb0c,0xb14
 a2d:	0b 00 00 
    base.s.size = 0;
 a30:	b9 0c 0b 00 00       	mov    $0xb0c,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 a35:	c7 05 0c 0b 00 00 0c 	movl   $0xb0c,0xb0c
 a3c:	0b 00 00 
    base.s.size = 0;
 a3f:	c7 05 10 0b 00 00 00 	movl   $0x0,0xb10
 a46:	00 00 00 
