...
fmtname(char *path)
{
  ...
  48:	c7 04 24 0c 0b 00 00 	movl   $0xb0c,(%esp)
  ...
  63:	bb 0c 0b 00 00       	mov    $0xb0c,%ebx
  ...
  81:	00 
  82:	05 0c 0b 00 00       	add    $0xb0c,%eax
...
ls(char *path)
{
 ...
 12d:	00 
 12e:	c7 44 24 04 cf 0a 00 	movl   $0xacf,0x4(%esp)
 135:	00 
 ...
 24d:	c7 44 24 04 cf 0a 00 	movl   $0xacf,0x4(%esp)
 254:	00 
 ...
 26a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_DIR:
    if(strlen(path) + 1 + DIRSIZ + 1 > sizeof buf){
      printf(1, "ls: path too long\n");
 270:	c7 44 24 04 dc 0a 00 	movl   $0xadc,0x4(%esp)
 277:	00 
 ...
 294:	c7 44 24 04 a7 0a 00 	movl   $0xaa7,0x4(%esp)
 29b:	00 
 ...
 2c2:	c7 44 24 04 bb 0a 00 	movl   $0xabb,0x4(%esp)
 2c9:	00 
 ...
 2e4:	c7 44 24 04 bb 0a 00 	movl   $0xabb,0x4(%esp)
 2eb:	00 
...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ls(".");
 348:	c7 04 24 ef 0a 00 00 	movl   $0xaef,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 65a:	f7 f7                	div    %edi
 65c:	0f b6 92 f8 0a 00 00 	movzbl 0xaf8(%edx),%edx
...
putc(int fd, char c)
{
 ...
 808:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 80b:	b9 f1 0a 00 00       	mov    $0xaf1,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 8d1:	a1 24 0b 00 00       	mov    0xb24,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 91f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 921:	a3 24 0b 00 00       	mov    %eax,0xb24
}
 926:	5b                   	pop    %ebx
 927:	5e                   	pop    %esi
 928:	5f                   	pop    %edi
 ...
 94b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 94d:	a3 24 0b 00 00       	mov    %eax,0xb24
}
 952:	5b                   	pop    %ebx
 953:	5e                   	pop    %esi
 954:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 969:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 96c:	8b 0d 24 0b 00 00    	mov    0xb24,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 99c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 9a0:	3b 05 24 0b 00 00    	cmp    0xb24,%eax
 ...
 9bf:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 9c2:	89 0d 24 0b 00 00    	mov    %ecx,0xb24
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 a02:	e8 c9 fe ff ff       	call   8d0 <free>
  return freep;
 a07:	8b 0d 24 0b 00 00    	mov    0xb24,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 a1c:	eb a4                	jmp    9c2 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 a1e:	c7 05 24 0b 00 00 1c 	movl   $0xb1c,0xb24
 a25:	0b 00 00 
    base.s.size = 0;
 a28:	b9 1c 0b 00 00       	mov    $0xb1c,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 a2d:	c7 05 1c 0b 00 00 1c 	movl   $0xb1c,0xb1c
 a34:	0b 00 00 
    base.s.size = 0;
 a37:	c7 05 20 0b 00 00 00 	movl   $0x0,0xb20
 a3e:	00 00 00 
...
//     panic("acquire");
 ...
 a77:	75 f7                	jne    a70 <lock_acquire+0x10>
    ;
...
lock_release(struct lock_t *lock)
{
 ...
 a88:	f0 87 02             	lock xchg %eax,(%edx)
