...
main(int argc, char **argv)
{
  ...
  if(argc < 1){
    printf(2, "usage: kill pid...\n");
  40:	c7 44 24 04 a7 07 00 	movl   $0x7a7,0x4(%esp)
  47:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 35a:	f7 f7                	div    %edi
 35c:	0f b6 92 c2 07 00 00 	movzbl 0x7c2(%edx),%edx
...
putc(int fd, char c)
{
 ...
 508:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 50b:	b9 bb 07 00 00       	mov    $0x7bb,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 5d1:	a1 dc 07 00 00       	mov    0x7dc,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 61f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 621:	a3 dc 07 00 00       	mov    %eax,0x7dc
}
 626:	5b                   	pop    %ebx
 627:	5e                   	pop    %esi
 628:	5f                   	pop    %edi
 ...
 64b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 64d:	a3 dc 07 00 00       	mov    %eax,0x7dc
}
 652:	5b                   	pop    %ebx
 653:	5e                   	pop    %esi
 654:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 669:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 66c:	8b 0d dc 07 00 00    	mov    0x7dc,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 69c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6a0:	3b 05 dc 07 00 00    	cmp    0x7dc,%eax
 ...
 6bf:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6c2:	89 0d dc 07 00 00    	mov    %ecx,0x7dc
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 702:	e8 c9 fe ff ff       	call   5d0 <free>
  return freep;
 707:	8b 0d dc 07 00 00    	mov    0x7dc,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 71c:	eb a4                	jmp    6c2 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 71e:	c7 05 dc 07 00 00 d4 	movl   $0x7d4,0x7dc
 725:	07 00 00 
    base.s.size = 0;
 728:	b9 d4 07 00 00       	mov    $0x7d4,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 72d:	c7 05 d4 07 00 00 d4 	movl   $0x7d4,0x7d4
 734:	07 00 00 
    base.s.size = 0;
 737:	c7 05 d8 07 00 00 00 	movl   $0x0,0x7d8
 73e:	00 00 00 
...
xchg(volatile uint *addr, uint newval)
{
 ...
 772:	f0 87 02             	lock xchg %eax,(%edx)
//     panic("acquire");
 ...
 777:	75 f7                	jne    770 <lock_acquire+0x10>
    ;
...
lock_release(struct lock_t *lock)
{
 ...
 788:	f0 87 02             	lock xchg %eax,(%edx)
