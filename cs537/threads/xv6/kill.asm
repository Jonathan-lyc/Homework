...
main(int argc, char **argv)
{
  ...
  if(argc < 1){
    printf(2, "usage: kill pid...\n");
  40:	c7 44 24 04 9a 07 00 	movl   $0x79a,0x4(%esp)
  47:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 35a:	f7 f7                	div    %edi
 35c:	0f b6 92 b5 07 00 00 	movzbl 0x7b5(%edx),%edx
...
putc(int fd, char c)
{
 ...
 5d0:	e9 30 fe ff ff       	jmp    405 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 5d5:	bf ae 07 00 00       	mov    $0x7ae,%edi
...
free(void *ap)
{
 ...
 5e1:	a1 d0 07 00 00       	mov    0x7d0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 62f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 631:	a3 d0 07 00 00       	mov    %eax,0x7d0
}
 636:	5b                   	pop    %ebx
 637:	5e                   	pop    %esi
 638:	5f                   	pop    %edi
 ...
 65b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 d0 07 00 00       	mov    %eax,0x7d0
}
 662:	5b                   	pop    %ebx
 663:	5e                   	pop    %esi
 664:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 679:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 67c:	8b 0d d0 07 00 00    	mov    0x7d0,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6a8:	3b 05 d0 07 00 00    	cmp    0x7d0,%eax
 ...
 6c7:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6ca:	89 0d d0 07 00 00    	mov    %ecx,0x7d0
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 70c:	e8 cf fe ff ff       	call   5e0 <free>
  return freep;
 711:	8b 0d d0 07 00 00    	mov    0x7d0,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 724:	eb a4                	jmp    6ca <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 d0 07 00 00 c8 	movl   $0x7c8,0x7d0
 72d:	07 00 00 
    base.s.size = 0;
 730:	b9 c8 07 00 00       	mov    $0x7c8,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 735:	c7 05 c8 07 00 00 c8 	movl   $0x7c8,0x7c8
 73c:	07 00 00 
    base.s.size = 0;
 73f:	c7 05 cc 07 00 00 00 	movl   $0x0,0x7cc
 746:	00 00 00 
