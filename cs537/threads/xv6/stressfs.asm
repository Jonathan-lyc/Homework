...
main(int argc, char *argv[])
{
  ...
  printf(1, "stressfs starting\n");
  24:	c7 44 24 04 17 08 00 	movl   $0x817,0x4(%esp)
  2b:	00 
  ...
  6a:	c7 44 24 04 2a 08 00 	movl   $0x82a,0x4(%esp)
  71:	00 
  ...
  a4:	83 c3 01             	add    $0x1,%ebx
    printf(fd, "%d\n", i);
  a7:	c7 44 24 04 2a 08 00 	movl   $0x82a,0x4(%esp)
  ae:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ca:	f7 f7                	div    %edi
 3cc:	0f b6 92 35 08 00 00 	movzbl 0x835(%edx),%edx
...
putc(int fd, char c)
{
 ...
 578:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 57b:	b9 2e 08 00 00       	mov    $0x82e,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 641:	a1 50 08 00 00       	mov    0x850,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 68f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 691:	a3 50 08 00 00       	mov    %eax,0x850
}
 696:	5b                   	pop    %ebx
 697:	5e                   	pop    %esi
 698:	5f                   	pop    %edi
 ...
 6bb:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 6bd:	a3 50 08 00 00       	mov    %eax,0x850
}
 6c2:	5b                   	pop    %ebx
 6c3:	5e                   	pop    %esi
 6c4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 6dc:	8b 0d 50 08 00 00    	mov    0x850,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 70c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 710:	3b 05 50 08 00 00    	cmp    0x850,%eax
 ...
 72f:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 732:	89 0d 50 08 00 00    	mov    %ecx,0x850
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 772:	e8 c9 fe ff ff       	call   640 <free>
  return freep;
 777:	8b 0d 50 08 00 00    	mov    0x850,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 78c:	eb a4                	jmp    732 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 78e:	c7 05 50 08 00 00 48 	movl   $0x848,0x850
 795:	08 00 00 
    base.s.size = 0;
 798:	b9 48 08 00 00       	mov    $0x848,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 79d:	c7 05 48 08 00 00 48 	movl   $0x848,0x848
 7a4:	08 00 00 
    base.s.size = 0;
 7a7:	c7 05 4c 08 00 00 00 	movl   $0x0,0x84c
 7ae:	00 00 00 
