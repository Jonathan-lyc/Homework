...
main(int argc, char *argv[])
{
  ...
  printf(1, "stressfs starting\n");
  24:	c7 44 24 04 0a 08 00 	movl   $0x80a,0x4(%esp)
  2b:	00 
  ...
  6a:	c7 44 24 04 1d 08 00 	movl   $0x81d,0x4(%esp)
  71:	00 
  ...
  a4:	83 c3 01             	add    $0x1,%ebx
    printf(fd, "%d\n", i);
  a7:	c7 44 24 04 1d 08 00 	movl   $0x81d,0x4(%esp)
  ae:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ca:	f7 f7                	div    %edi
 3cc:	0f b6 92 28 08 00 00 	movzbl 0x828(%edx),%edx
...
putc(int fd, char c)
{
 ...
 640:	e9 30 fe ff ff       	jmp    475 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 645:	bf 21 08 00 00       	mov    $0x821,%edi
...
free(void *ap)
{
 ...
 651:	a1 44 08 00 00       	mov    0x844,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 69f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6a1:	a3 44 08 00 00       	mov    %eax,0x844
}
 6a6:	5b                   	pop    %ebx
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 ...
 6cb:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 6cd:	a3 44 08 00 00       	mov    %eax,0x844
}
 6d2:	5b                   	pop    %ebx
 6d3:	5e                   	pop    %esi
 6d4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 6ec:	8b 0d 44 08 00 00    	mov    0x844,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 714:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 718:	3b 05 44 08 00 00    	cmp    0x844,%eax
 ...
 737:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 73a:	89 0d 44 08 00 00    	mov    %ecx,0x844
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 77c:	e8 cf fe ff ff       	call   650 <free>
  return freep;
 781:	8b 0d 44 08 00 00    	mov    0x844,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 794:	eb a4                	jmp    73a <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 796:	c7 05 44 08 00 00 3c 	movl   $0x83c,0x844
 79d:	08 00 00 
    base.s.size = 0;
 7a0:	b9 3c 08 00 00       	mov    $0x83c,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7a5:	c7 05 3c 08 00 00 3c 	movl   $0x83c,0x83c
 7ac:	08 00 00 
    base.s.size = 0;
 7af:	c7 05 40 08 00 00 00 	movl   $0x0,0x840
 7b6:	00 00 00 
