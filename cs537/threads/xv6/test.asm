...
void ll_coolj(){
  ...
  struct node *n;
  n = head;
   8:	a1 48 08 00 00       	mov    0x848,%eax
  int i = 0;
  while(n != 0) {
   d:	85 c0                	test   %eax,%eax
   f:	74 10                	je     21 <ll_coolj+0x21>
  11:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    i += n->data;
  18:	03 10                	add    (%eax),%edx
    n = n->next;
...
void ll_coolj(){
  ...
  1f:	75 f7                	jne    18 <ll_coolj+0x18>
    i += n->data;
    n = n->next;
  }
  printf(1, "total = %d", i);
  21:	89 54 24 08          	mov    %edx,0x8(%esp)
  25:	c7 44 24 04 06 08 00 	movl   $0x806,0x4(%esp)
  2c:	00 
...
void ll_print(){
  ...
  struct node *n;
  n = head;
  47:	8b 1d 48 08 00 00    	mov    0x848,%ebx
  while(n != 0) {
  4d:	85 db                	test   %ebx,%ebx
  4f:	74 28                	je     79 <ll_print+0x39>
...
ll_add(int i){
  ...
  86:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
  8d:	e8 8e 06 00 00       	call   720 <malloc>
  n->data = i;
  92:	8b 55 08             	mov    0x8(%ebp),%edx
  n->next = 0;
  95:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
...
ll_add(int i){
  ...
  n = (struct node *)malloc(sizeof(struct node));
  n->data = i;
  9c:	89 10                	mov    %edx,(%eax)
  n->next = 0;
  if (head == 0) {
  9e:	8b 15 48 08 00 00    	mov    0x848,%edx
  a4:	85 d2                	test   %edx,%edx
  a6:	74 10                	je     b8 <ll_add+0x38>
    head = n;
  } else {
...
/*    printf(1, "i = %d", i);*/
  ...
  aa:	8b 52 04             	mov    0x4(%edx),%edx
  ad:	85 d2                	test   %edx,%edx
  af:	75 f7                	jne    a8 <ll_add+0x28>
/*      printf(1, "next! i = %d", i);*/
      curr = curr->next;
    }
    curr->next = n;
  b1:	89 41 04             	mov    %eax,0x4(%ecx)
/*    printf(1, "currnext = %d\n", curr->next);*/
  }
}
  b4:	c9                   	leave  
  ...
  if (head == 0) {
    head = n;
  b8:	a3 48 08 00 00       	mov    %eax,0x848
      curr = curr->next;
    }
    curr->next = n;
/*    printf(1, "currnext = %d\n", curr->next);*/
...
main (int argc, char* argv[]) {
  ...
  printf(1, "test");
  c9:	c7 44 24 04 15 08 00 	movl   $0x815,0x4(%esp)
  d0:	00 
  d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  d8:	e8 b3 03 00 00       	call   490 <printf>
  char* stack = malloc(4096);
  dd:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  e4:	e8 37 06 00 00       	call   720 <malloc>
  int i = clone(stack, 4096);
  e9:	c7 44 24 04 00 10 00 	movl   $0x1000,0x4(%esp)
  f0:	00 
  f1:	89 04 24             	mov    %eax,(%esp)
  f4:	e8 ef 02 00 00       	call   3e8 <clone>
  
  printf(1, "i = %d", i);
  f9:	c7 44 24 04 1a 08 00 	movl   $0x81a,0x4(%esp)
 100:	00 
...
//   ll_coolj();
  exit();
 111:	e8 32 02 00 00       	call   348 <exit>
 116:	90                   	nop
 117:	90                   	nop
 118:	90                   	nop
 119:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41a:	f7 f7                	div    %edi
 41c:	0f b6 92 28 08 00 00 	movzbl 0x828(%edx),%edx
...
putc(int fd, char c)
{
 ...
 5c8:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 5cb:	b9 21 08 00 00       	mov    $0x821,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 691:	a1 44 08 00 00       	mov    0x844,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6df:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6e1:	a3 44 08 00 00       	mov    %eax,0x844
}
 6e6:	5b                   	pop    %ebx
 6e7:	5e                   	pop    %esi
 6e8:	5f                   	pop    %edi
 ...
 70b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 70d:	a3 44 08 00 00       	mov    %eax,0x844
}
 712:	5b                   	pop    %ebx
 713:	5e                   	pop    %esi
 714:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 729:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 72c:	8b 0d 44 08 00 00    	mov    0x844,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 75c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 760:	3b 05 44 08 00 00    	cmp    0x844,%eax
 ...
 77f:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 782:	89 0d 44 08 00 00    	mov    %ecx,0x844
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 7c2:	e8 c9 fe ff ff       	call   690 <free>
  return freep;
 7c7:	8b 0d 44 08 00 00    	mov    0x844,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7dc:	eb a4                	jmp    782 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7de:	c7 05 44 08 00 00 3c 	movl   $0x83c,0x844
 7e5:	08 00 00 
    base.s.size = 0;
 7e8:	b9 3c 08 00 00       	mov    $0x83c,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7ed:	c7 05 3c 08 00 00 3c 	movl   $0x83c,0x83c
 7f4:	08 00 00 
    base.s.size = 0;
 7f7:	c7 05 40 08 00 00 00 	movl   $0x0,0x840
 7fe:	00 00 00 
