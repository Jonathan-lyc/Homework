...
cat(int fd)
{
  ...
  if(n < 0){
    printf(1, "cat: read error\n");
  51:	c7 44 24 04 57 08 00 	movl   $0x857,0x4(%esp)
  58:	00 
...
main(int argc, char *argv[])
{
  ...
  d2:	c7 44 24 04 68 08 00 	movl   $0x868,0x4(%esp)
  d9:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40a:	f7 f7                	div    %edi
 40c:	0f b6 92 84 08 00 00 	movzbl 0x884(%edx),%edx
...
putc(int fd, char c)
{
 ...
 4d3:	0f 84 47 01 00 00    	je     620 <printf+0x1a0>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
 ...
 500:	0f 84 42 01 00 00    	je     648 <printf+0x1c8>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 506:	83 fa 25             	cmp    $0x25,%edx
 509:	0f 84 01 01 00 00    	je     610 <printf+0x190>
#include "user.h"
...
putc(int fd, char c)
{
 ...
 512:	89 55 cc             	mov    %edx,-0x34(%ebp)
 515:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
 519:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
 520:	00 
 521:	89 74 24 04          	mov    %esi,0x4(%esp)
 525:	89 0c 24             	mov    %ecx,(%esp)
 528:	e8 2b fe ff ff       	call   358 <write>
 52d:	8b 55 cc             	mov    -0x34(%ebp),%edx
...
putc(int fd, char c)
{
 ...
 53b:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
 542:	00 
...
putc(int fd, char c)
{
 ...
 5b8:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 5bb:	b9 7d 08 00 00       	mov    $0x87d,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
        ...
        s = (char*)*ap;
 5c0:	8b 3a                	mov    (%edx),%edi
        ap++;
 5c2:	83 c2 04             	add    $0x4,%edx
 5c5:	89 55 d4             	mov    %edx,-0x2c(%ebp)
        if(s == 0)
 5c8:	85 ff                	test   %edi,%edi
 5ca:	0f 44 f9             	cmove  %ecx,%edi
          s = "(null)";
        while(*s != 0){
 5cd:	0f b6 17             	movzbl (%edi),%edx
 5d0:	84 d2                	test   %dl,%dl
 5d2:	74 33                	je     607 <printf+0x187>
 5d4:	89 5d d0             	mov    %ebx,-0x30(%ebp)
...
putc(int fd, char c)
{
 ...
 5f5:	e8 5e fd ff ff       	call   358 <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
          s = "(null)";
        while(*s != 0){
 5fa:	0f b6 17             	movzbl (%edi),%edx
 5fd:	84 d2                	test   %dl,%dl
 5ff:	75 df                	jne    5e0 <printf+0x160>
 601:	8b 5d d0             	mov    -0x30(%ebp),%ebx
...
putc(int fd, char c)
{
 ...
 609:	e9 a7 fe ff ff       	jmp    4b5 <printf+0x35>
 ...
 614:	e9 1a ff ff ff       	jmp    533 <printf+0xb3>
 ...
 637:	e8 a4 fd ff ff       	call   3e0 <printint>
 63c:	8b 45 0c             	mov    0xc(%ebp),%eax
        ap++;
 63f:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
 643:	e9 6d fe ff ff       	jmp    4b5 <printf+0x35>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
...
putc(int fd, char c)
{
 ...
 659:	00 
 65a:	89 74 24 04          	mov    %esi,0x4(%esp)
 65e:	89 0c 24             	mov    %ecx,(%esp)
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
...
{
  write(fd, &c, 1);
 664:	e8 ef fc ff ff       	call   358 <write>
 669:	8b 45 0c             	mov    0xc(%ebp),%eax
        ...
        putc(fd, *ap);
        ap++;
 66c:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
 670:	e9 40 fe ff ff       	jmp    4b5 <printf+0x35>
 675:	90                   	nop
 676:	90                   	nop
 677:	90                   	nop
 678:	90                   	nop
...
free(void *ap)
{
 ...
 681:	a1 a8 08 00 00       	mov    0x8a8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6cf:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6d1:	a3 a8 08 00 00       	mov    %eax,0x8a8
}
 6d6:	5b                   	pop    %ebx
 6d7:	5e                   	pop    %esi
 6d8:	5f                   	pop    %edi
 ...
 6fb:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 6fd:	a3 a8 08 00 00       	mov    %eax,0x8a8
}
 702:	5b                   	pop    %ebx
 703:	5e                   	pop    %esi
 704:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 719:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 71c:	8b 0d a8 08 00 00    	mov    0x8a8,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 74c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 750:	3b 05 a8 08 00 00    	cmp    0x8a8,%eax
 ...
 76f:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 772:	89 0d a8 08 00 00    	mov    %ecx,0x8a8
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 79f:	e8 1c fc ff ff       	call   3c0 <sbrk>
  if(p == (char*)-1)
 ...
 7b2:	e8 c9 fe ff ff       	call   680 <free>
  return freep;
 7b7:	8b 0d a8 08 00 00    	mov    0x8a8,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7cc:	eb a4                	jmp    772 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7ce:	c7 05 a8 08 00 00 a0 	movl   $0x8a0,0x8a8
 7d5:	08 00 00 
    base.s.size = 0;
 7d8:	b9 a0 08 00 00       	mov    $0x8a0,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7dd:	c7 05 a0 08 00 00 a0 	movl   $0x8a0,0x8a0
 7e4:	08 00 00 
    base.s.size = 0;
 7e7:	c7 05 a4 08 00 00 00 	movl   $0x0,0x8a4
 7ee:	00 00 00 
...
lock_init(struct lock_t *lock)
{
 ...
 806:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 80c:	5d                   	pop    %ebp
 80d:	c3                   	ret    
