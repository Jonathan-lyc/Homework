...
cat(int fd)
{
  ...
  if(n < 0){
    printf(1, "cat: read error\n");
  51:	c7 44 24 04 4a 08 00 	movl   $0x84a,0x4(%esp)
  58:	00 
...
main(int argc, char *argv[])
{
  ...
  d2:	c7 44 24 04 5b 08 00 	movl   $0x85b,0x4(%esp)
  d9:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40a:	f7 f7                	div    %edi
 40c:	0f b6 92 77 08 00 00 	movzbl 0x877(%edx),%edx
...
putc(int fd, char c)
{
 ...
 680:	e9 30 fe ff ff       	jmp    4b5 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 685:	bf 70 08 00 00       	mov    $0x870,%edi
...
free(void *ap)
{
 ...
 691:	a1 a8 08 00 00       	mov    0x8a8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6df:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6e1:	a3 a8 08 00 00       	mov    %eax,0x8a8
}
 6e6:	5b                   	pop    %ebx
 6e7:	5e                   	pop    %esi
 6e8:	5f                   	pop    %edi
 ...
 70b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 70d:	a3 a8 08 00 00       	mov    %eax,0x8a8
}
 712:	5b                   	pop    %ebx
 713:	5e                   	pop    %esi
 714:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 729:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 72c:	8b 0d a8 08 00 00    	mov    0x8a8,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 754:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 758:	3b 05 a8 08 00 00    	cmp    0x8a8,%eax
 ...
 777:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 77a:	89 0d a8 08 00 00    	mov    %ecx,0x8a8
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 7bc:	e8 cf fe ff ff       	call   690 <free>
  return freep;
 7c1:	8b 0d a8 08 00 00    	mov    0x8a8,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7d4:	eb a4                	jmp    77a <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7d6:	c7 05 a8 08 00 00 a0 	movl   $0x8a0,0x8a8
 7dd:	08 00 00 
    base.s.size = 0;
 7e0:	b9 a0 08 00 00       	mov    $0x8a0,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7e5:	c7 05 a0 08 00 00 a0 	movl   $0x8a0,0x8a0
 7ec:	08 00 00 
    base.s.size = 0;
 7ef:	c7 05 a4 08 00 00 00 	movl   $0x0,0x8a4
 7f6:	00 00 00 
