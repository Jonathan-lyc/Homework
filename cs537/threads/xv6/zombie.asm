...
printint(int fd, int xx, int base, int sgn)
{
 ...
 32a:	f7 f7                	div    %edi
 32c:	0f b6 92 7e 07 00 00 	movzbl 0x77e(%edx),%edx
...
putc(int fd, char c)
{
 ...
 4d8:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 4db:	b9 77 07 00 00       	mov    $0x777,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 5a1:	a1 98 07 00 00       	mov    0x798,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5ef:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5f1:	a3 98 07 00 00       	mov    %eax,0x798
}
 5f6:	5b                   	pop    %ebx
 5f7:	5e                   	pop    %esi
 5f8:	5f                   	pop    %edi
 ...
 61b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 61d:	a3 98 07 00 00       	mov    %eax,0x798
}
 622:	5b                   	pop    %ebx
 623:	5e                   	pop    %esi
 624:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 639:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 63c:	8b 0d 98 07 00 00    	mov    0x798,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 66c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 670:	3b 05 98 07 00 00    	cmp    0x798,%eax
 ...
 68f:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 692:	89 0d 98 07 00 00    	mov    %ecx,0x798
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 6d2:	e8 c9 fe ff ff       	call   5a0 <free>
  return freep;
 6d7:	8b 0d 98 07 00 00    	mov    0x798,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6ec:	eb a4                	jmp    692 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6ee:	c7 05 98 07 00 00 90 	movl   $0x790,0x798
 6f5:	07 00 00 
    base.s.size = 0;
 6f8:	b9 90 07 00 00       	mov    $0x790,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6fd:	c7 05 90 07 00 00 90 	movl   $0x790,0x790
 704:	07 00 00 
    base.s.size = 0;
 707:	c7 05 94 07 00 00 00 	movl   $0x0,0x794
 70e:	00 00 00 
...
//     panic("acquire");
 ...
 747:	75 f7                	jne    740 <lock_acquire+0x10>
    ;
