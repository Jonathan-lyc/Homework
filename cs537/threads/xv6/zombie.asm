...
printint(int fd, int xx, int base, int sgn)
{
 ...
 32a:	f7 f7                	div    %edi
 32c:	0f b6 92 71 07 00 00 	movzbl 0x771(%edx),%edx
...
putc(int fd, char c)
{
 ...
 5a0:	e9 30 fe ff ff       	jmp    3d5 <printf+0x35>
        ...
        ap++;
        if(s == 0)
 5a5:	bf 6a 07 00 00       	mov    $0x76a,%edi
...
free(void *ap)
{
 ...
 5b1:	a1 8c 07 00 00       	mov    0x78c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5ff:	89 08                	mov    %ecx,(%eax)
  freep = p;
 601:	a3 8c 07 00 00       	mov    %eax,0x78c
}
 606:	5b                   	pop    %ebx
 607:	5e                   	pop    %esi
 608:	5f                   	pop    %edi
 ...
 62b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 62d:	a3 8c 07 00 00       	mov    %eax,0x78c
}
 632:	5b                   	pop    %ebx
 633:	5e                   	pop    %esi
 634:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 649:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 64c:	8b 0d 8c 07 00 00    	mov    0x78c,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 674:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 678:	3b 05 8c 07 00 00    	cmp    0x78c,%eax
 ...
 697:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 69a:	89 0d 8c 07 00 00    	mov    %ecx,0x78c
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 6dc:	e8 cf fe ff ff       	call   5b0 <free>
  return freep;
 6e1:	8b 0d 8c 07 00 00    	mov    0x78c,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6f4:	eb a4                	jmp    69a <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6f6:	c7 05 8c 07 00 00 84 	movl   $0x784,0x78c
 6fd:	07 00 00 
    base.s.size = 0;
 700:	b9 84 07 00 00       	mov    $0x784,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 705:	c7 05 84 07 00 00 84 	movl   $0x784,0x784
 70c:	07 00 00 
    base.s.size = 0;
 70f:	c7 05 88 07 00 00 00 	movl   $0x0,0x788
 716:	00 00 00 
