...
wc(int fd, char *name)
{
  ...
  50:	7e 38                	jle    8a <wc+0x8a>
      c++;
      if(buf[i] == '\n')
  52:	0f be 83 60 09 00 00 	movsbl 0x960(%ebx),%eax
        l++;
  59:	31 d2                	xor    %edx,%edx
      if(strchr(" \r\t\n\v", buf[i]))
  5b:	c7 04 24 e7 08 00 00 	movl   $0x8e7,(%esp)
  inword = 0;
  while((n = read(fd, buf, sizeof(buf))) > 0){
    for(i=0; i<n; i++){
      c++;
  ...
  9b:	c7 44 24 04 fd 08 00 	movl   $0x8fd,0x4(%esp)
  a2:	00 
  ...
  if(n < 0){
    printf(1, "wc: read error\n");
  c9:	c7 44 24 04 ed 08 00 	movl   $0x8ed,0x4(%esp)
  d0:	00 
...
main(int argc, char *argv[])
{
 ...
 15a:	c7 44 24 04 0a 09 00 	movl   $0x90a,0x4(%esp)
 161:	00 
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
    wc(0, "");
 178:	c7 44 24 04 fc 08 00 	movl   $0x8fc,0x4(%esp)
 17f:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49a:	f7 f7                	div    %edi
 49c:	0f b6 92 26 09 00 00 	movzbl 0x926(%edx),%edx
...
putc(int fd, char c)
{
 ...
 648:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 64b:	b9 1f 09 00 00       	mov    $0x91f,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 711:	a1 48 09 00 00       	mov    0x948,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 75f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 761:	a3 48 09 00 00       	mov    %eax,0x948
}
 766:	5b                   	pop    %ebx
 767:	5e                   	pop    %esi
 768:	5f                   	pop    %edi
 ...
 78b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 78d:	a3 48 09 00 00       	mov    %eax,0x948
}
 792:	5b                   	pop    %ebx
 793:	5e                   	pop    %esi
 794:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 7ac:	8b 0d 48 09 00 00    	mov    0x948,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 7dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 7e0:	3b 05 48 09 00 00    	cmp    0x948,%eax
 ...
 7ff:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 802:	89 0d 48 09 00 00    	mov    %ecx,0x948
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 842:	e8 c9 fe ff ff       	call   710 <free>
  return freep;
 847:	8b 0d 48 09 00 00    	mov    0x948,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 85c:	eb a4                	jmp    802 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 85e:	c7 05 48 09 00 00 40 	movl   $0x940,0x948
 865:	09 00 00 
    base.s.size = 0;
 868:	b9 40 09 00 00       	mov    $0x940,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 86d:	c7 05 40 09 00 00 40 	movl   $0x940,0x940
 874:	09 00 00 
    base.s.size = 0;
 877:	c7 05 44 09 00 00 00 	movl   $0x0,0x944
 87e:	00 00 00 
...
//     panic("acquire");
 ...
 8b7:	75 f7                	jne    8b0 <lock_acquire+0x10>
    ;
...
lock_release(struct lock_t *lock)
{
 ...
 8c8:	f0 87 02             	lock xchg %eax,(%edx)
