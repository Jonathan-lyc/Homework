...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      22:	ff 24 85 8c 13 00 00 	jmp    *0x138c(,%eax,4)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
      ...
      d2:	c7 04 24 8c 14 00 00 	movl   $0x148c,(%esp)
     ...
     150:	83 c3 01             	add    $0x1,%ebx
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     15a:	c7 04 24 8c 14 00 00 	movl   $0x148c,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     1aa:	c7 04 24 8c 14 00 00 	movl   $0x148c,(%esp)
  ...
  *ps = s;
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     1f3:	c7 04 24 92 14 00 00 	movl   $0x1492,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     215:	c7 04 24 8c 14 00 00 	movl   $0x148c,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     419:	c7 44 24 04 25 14 00 	movl   $0x1425,0x4(%esp)
     420:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     450:	c7 44 24 08 d9 13 00 	movl   $0x13d9,0x8(%esp)
     457:	00 
     ...
     48c:	89 3c 24             	mov    %edi,(%esp)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     4a9:	c7 04 24 bc 13 00 00 	movl   $0x13bc,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     52f:	c7 44 24 08 dc 13 00 	movl   $0x13dc,0x8(%esp)
     536:	00 
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     586:	c7 44 24 08 f3 13 00 	movl   $0x13f3,0x8(%esp)
     58d:	00 
    ...
    if(tok != 'a')
     ...
     5bf:	74 0c                	je     5cd <parseexec+0xad>
      panic("syntax");
     5c1:	c7 04 24 de 13 00 00 	movl   $0x13de,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     5e4:	7e 8a                	jle    570 <parseexec+0x50>
      panic("too many args");
     5e6:	c7 04 24 e5 13 00 00 	movl   $0x13e5,(%esp)
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     661:	c7 44 24 08 f8 13 00 	movl   $0x13f8,0x8(%esp)
     668:	00 
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     716:	c7 44 24 08 fa 13 00 	movl   $0x13fa,0x8(%esp)
     71d:	00 
  ...
  if(peek(ps, es, ";")){
     72e:	c7 44 24 08 f6 13 00 	movl   $0x13f6,0x8(%esp)
     735:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     7a5:	c7 44 24 08 dc 13 00 	movl   $0x13dc,0x8(%esp)
     7ac:	00 
  ...
  if(!peek(ps, es, ")"))
     7e9:	c7 44 24 08 18 14 00 	movl   $0x1418,0x8(%esp)
     7f0:	00 
  ...
  if(!peek(ps, es, ")"))
    ...
    panic("syntax - missing )");
     803:	c7 04 24 07 14 00 00 	movl   $0x1407,(%esp)
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
    panic("parseblock");
     848:	c7 04 24 fc 13 00 00 	movl   $0x13fc,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     884:	c7 44 24 08 47 14 00 	movl   $0x1447,0x8(%esp)
     88b:	00 
     88c:	89 5c 24 04          	mov    %ebx,0x4(%esp)
{
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     8a8:	c7 44 24 04 1a 14 00 	movl   $0x141a,0x4(%esp)
     8af:	00 
     8b0:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     8b7:	e8 04 07 00 00       	call   fc0 <printf>
    panic("syntax");
     8bc:	c7 04 24 de 13 00 00 	movl   $0x13de,(%esp)
     ...
     8f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
{
  ...
  if(pid == -1)
    panic("fork");
     8f8:	c7 04 24 29 14 00 00 	movl   $0x1429,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     922:	c7 44 24 04 2e 14 00 	movl   $0x142e,0x4(%esp)
     929:	00 
...
runcmd(struct cmd *cmd)
{
  ...
  default:
    panic("runcmd");
     983:	c7 04 24 31 14 00 00 	movl   $0x1431,(%esp)
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     9a8:	c7 44 24 04 38 14 00 	movl   $0x1438,0x4(%esp)
     9af:	00 
  ...
  switch(cmd->type){
     ...
     9ca:	ff 24 85 a4 13 00 00 	jmp    *0x13a4(,%eax,4)
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     b33:	c7 44 24 04 48 14 00 	movl   $0x1448,0x4(%esp)
     b3a:	00 
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
      panic("pipe");
     b50:	c7 04 24 58 14 00 00 	movl   $0x1458,(%esp)
...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     b87:	00 
     b88:	c7 04 24 5d 14 00 00 	movl   $0x145d,(%esp)
    ...
    if(fork1() == 0)
      runcmd(parsecmd(buf));
     ba7:	c7 04 24 a0 14 00 00 	movl   $0x14a0,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     bc7:	00 
     bc8:	c7 04 24 a0 14 00 00 	movl   $0x14a0,(%esp)
     bcf:	e8 3c fd ff ff       	call   910 <getcmd>
     bd4:	85 c0                	test   %eax,%eax
     bd6:	78 70                	js     c48 <main+0xd8>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     bd8:	80 3d a0 14 00 00 63 	cmpb   $0x63,0x14a0
     bdf:	75 09                	jne    bea <main+0x7a>
     be1:	80 3d a1 14 00 00 64 	cmpb   $0x64,0x14a1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     bf8:	80 3d a2 14 00 00 20 	cmpb   $0x20,0x14a2
     bff:	90                   	nop
     c00:	75 e8                	jne    bea <main+0x7a>
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     c02:	c7 04 24 a0 14 00 00 	movl   $0x14a0,(%esp)
     c09:	e8 c2 00 00 00       	call   cd0 <strlen>
      if(chdir(buf+3) < 0)
     c0e:	c7 04 24 a3 14 00 00 	movl   $0x14a3,(%esp)
  // Read and run input commands.
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     c15:	c6 80 9f 14 00 00 00 	movb   $0x0,0x149f(%eax)
      if(chdir(buf+3) < 0)
     c1c:	e8 c7 02 00 00       	call   ee8 <chdir>
     c21:	85 c0                	test   %eax,%eax
     c23:	79 9b                	jns    bc0 <main+0x50>
        printf(2, "cannot cd %s\n", buf+3);
     c25:	c7 44 24 08 a3 14 00 	movl   $0x14a3,0x8(%esp)
     c2c:	00 
     c2d:	c7 44 24 04 65 14 00 	movl   $0x1465,0x4(%esp)
     c34:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f4a:	f7 f7                	div    %edi
     f4c:	0f b6 92 7a 14 00 00 	movzbl 0x147a(%edx),%edx
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    11c0:	e9 30 fe ff ff       	jmp    ff5 <printf+0x35>
        ...
        ap++;
        if(s == 0)
    11c5:	bf 73 14 00 00       	mov    $0x1473,%edi
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11d1:	a1 0c 15 00 00       	mov    0x150c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  freep = p;
    1221:	a3 0c 15 00 00       	mov    %eax,0x150c
}
    1226:	5b                   	pop    %ebx
    1227:	5e                   	pop    %esi
    1228:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    124d:	a3 0c 15 00 00       	mov    %eax,0x150c
}
    1252:	5b                   	pop    %ebx
    1253:	5e                   	pop    %esi
    1254:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    126c:	8b 0d 0c 15 00 00    	mov    0x150c,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1298:	3b 05 0c 15 00 00    	cmp    0x150c,%eax
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    12b7:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
    12ba:	89 0d 0c 15 00 00    	mov    %ecx,0x150c
      return (void*)(p + 1);
...
morecore(uint nu)
{
  ...
  return freep;
    1301:	8b 0d 0c 15 00 00    	mov    0x150c,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    1316:	c7 05 0c 15 00 00 04 	movl   $0x1504,0x150c
    131d:	15 00 00 
    base.s.size = 0;
    1320:	b9 04 15 00 00       	mov    $0x1504,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    1325:	c7 05 04 15 00 00 04 	movl   $0x1504,0x1504
    132c:	15 00 00 
    base.s.size = 0;
    132f:	c7 05 08 15 00 00 00 	movl   $0x0,0x1508
    1336:	00 00 00 
