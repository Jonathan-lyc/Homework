...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
      16:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
      1b:	c7 44 24 04 18 39 00 	movl   $0x3918,0x4(%esp)
      22:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
      53:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
      58:	c7 44 24 04 33 39 00 	movl   $0x3933,0x4(%esp)
      5f:	00 
  ...
  for(i = 0; i < sizeof(uninit); i++){
    if(uninit[i] != '\0'){
      printf(stdout, "bss test failed\n");
      6a:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
      6f:	c7 44 24 04 22 39 00 	movl   $0x3922,0x4(%esp)
      76:	00 
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
      96:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
      9b:	c7 44 24 04 40 39 00 	movl   $0x3940,0x4(%esp)
      a2:	00 
  ...
  fd = open("echo", 0);
      ...
      b2:	00 
      b3:	c7 04 24 4b 39 00 00 	movl   $0x394b,(%esp)
  ...
  fd = open("doesnotexist", 0);
      ...
      d2:	00 
      d3:	c7 04 24 63 39 00 00 	movl   $0x3963,(%esp)
  ...
  printf(stdout, "open test ok\n");
      e3:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
      e8:	c7 44 24 04 8e 39 00 	movl   $0x398e,0x4(%esp)
      ef:	00 
  ...
  if(fd < 0){
    printf(stdout, "open echo failed!\n");
      fa:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
      ff:	c7 44 24 04 50 39 00 	movl   $0x3950,0x4(%esp)
     106:	00 
  ...
  if(fd >= 0){
    printf(stdout, "open doesnotexist succeeded!\n");
     114:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     119:	c7 44 24 04 70 39 00 	movl   $0x3970,0x4(%esp)
     120:	00 
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     136:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     13b:	c7 44 24 04 9c 39 00 	movl   $0x399c,0x4(%esp)
     142:	00 
     143:	89 04 24             	mov    %eax,(%esp)
     146:	e8 f5 33 00 00       	call   3540 <printf>
  if(exec("echo", echoargv) < 0){
     14b:	c7 44 24 04 58 4e 00 	movl   $0x4e58,0x4(%esp)
     152:	00 
     153:	c7 04 24 4b 39 00 00 	movl   $0x394b,(%esp)
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
    printf(stdout, "exec echo failed\n");
     165:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     16a:	c7 44 24 04 a7 39 00 	movl   $0x39a7,0x4(%esp)
     171:	00 
...
bigargtest(void)
{
  ...
  if(pid == 0){
    ...
    for(i = 0; i < 32; i++)
     ...
     1b8:	c7 04 83 4c 47 00 00 	movl   $0x474c,(%ebx,%eax,4)
  ppid = getpid();
  pid = fork();
  if(pid == 0){
    char *args[32+1];
    ...
    args[32] = 0;
    printf(stdout, "bigarg test\n");
     1c7:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
  if(pid == 0){
    char *args[32+1];
    int i;
    for(i = 0; i < 32; i++)
    ...
    printf(stdout, "bigarg test\n");
     1d3:	c7 44 24 04 b9 39 00 	movl   $0x39b9,0x4(%esp)
     1da:	00 
     1db:	89 04 24             	mov    %eax,(%esp)
     1de:	e8 5d 33 00 00       	call   3540 <printf>
    exec("echo", args);
     1e3:	89 5c 24 04          	mov    %ebx,0x4(%esp)
     1e7:	c7 04 24 4b 39 00 00 	movl   $0x394b,(%esp)
     1ee:	e8 3d 32 00 00       	call   3430 <exec>
    printf(stdout, "bigarg test ok\n");
     1f3:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     1f8:	c7 44 24 04 c6 39 00 	movl   $0x39c6,0x4(%esp)
     1ff:	00 
    ...
    printf(stdout, "bigargtest: fork failed\n");
     20d:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     212:	c7 44 24 04 d6 39 00 	movl   $0x39d6,0x4(%esp)
     219:	00 
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
     239:	c7 44 24 04 ef 39 00 	movl   $0x39ef,0x4(%esp)
     240:	00 
     ...
     250:	74 72                	je     2c4 <forktest+0x94>
{
  ...
  printf(1, "fork test OK\n");
     292:	c7 44 24 04 21 3a 00 	movl   $0x3a21,0x4(%esp)
     299:	00 
  ...
  if(n == 1000){
    printf(1, "fork claimed to work 1000 times!\n");
     2b0:	c7 44 24 04 d8 47 00 	movl   $0x47d8,0x4(%esp)
     2b7:	00 
  ...
  for(; n > 0; n--){
    if(wait() < 0){
      printf(1, "wait stopped early\n");
     2c9:	c7 44 24 04 fa 39 00 	movl   $0x39fa,0x4(%esp)
     2d0:	00 
  ...
  if(wait() != -1){
    printf(1, "wait got too many\n");
     2e2:	c7 44 24 04 0e 3a 00 	movl   $0x3a0e,0x4(%esp)
     2e9:	00 
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     32d:	7d e1                	jge    310 <exitwait+0x10>
      printf(1, "fork failed\n");
     32f:	c7 44 24 04 e2 39 00 	movl   $0x39e2,0x4(%esp)
     336:	00 
  ...
  printf(1, "exitwait ok\n");
    ...
    if(pid){
     ...
     350:	c7 44 24 04 2f 3a 00 	movl   $0x3a2f,0x4(%esp)
     357:	00 
  ...
  printf(1, "exitwait ok\n");
     370:	c7 44 24 04 3f 3a 00 	movl   $0x3a3f,0x4(%esp)
     377:	00 
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
     39a:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     39f:	c7 44 24 04 4c 3a 00 	movl   $0x3a4c,0x4(%esp)
     3a6:	00 
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     3e4:	c7 04 24 5b 3a 00 00 	movl   $0x3a5b,(%esp)
  ...
  printf(stdout, "validate ok\n");
     403:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     408:	c7 44 24 04 7f 3a 00 	movl   $0x3a7f,0x4(%esp)
     40f:	00 
    ...
    if(link("nosuchfile", (char*)p) != -1){
      printf(stdout, "link should not succeed\n");
     41f:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     424:	c7 44 24 04 66 3a 00 	movl   $0x3a66,0x4(%esp)
     42b:	00 
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
     44e:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     453:	c7 44 24 04 8c 3a 00 	movl   $0x3a8c,0x4(%esp)
     45a:	00 
  ...
  *lastaddr = 99;
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    if((pids[i] = fork()) == 0){
     ...
     698:	00 
     699:	c7 44 24 04 55 40 00 	movl   $0x4055,0x4(%esp)
     6a0:	00 
  ...
  printf(stdout, "sbrk test OK\n");
     706:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     70b:	c7 44 24 04 43 3b 00 	movl   $0x3b43,0x4(%esp)
     712:	00 
  ...
  for(i = 0; i < 5000; i++){
    ...
    if(b != a){
     ...
     72a:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     72f:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
     733:	89 74 24 08          	mov    %esi,0x8(%esp)
     737:	c7 44 24 04 97 3a 00 	movl   $0x3a97,0x4(%esp)
     73e:	00 
  ...
  if(c == (char*)0xffffffff){
    printf(stdout, "failed sbrk leaked memory\n");
     76a:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     76f:	c7 44 24 04 28 3b 00 	movl   $0x3b28,0x4(%esp)
     776:	00 
  ...
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
     784:	c7 44 24 04 19 3b 00 	movl   $0x3b19,0x4(%esp)
     78b:	00 
    ...
    if(pid == 0){
     ...
     7a4:	c7 44 24 04 00 3b 00 	movl   $0x3b00,0x4(%esp)
     7ab:	00 
     7ac:	89 44 24 0c          	mov    %eax,0xc(%esp)
     7b0:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
  ...
  for(a = (char*)(640*1024); a < (char*)2000000; a += 50000){
    ...
    if(pid < 0){
      printf(stdout, "fork failed\n");
     7ca:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     7cf:	c7 44 24 04 e2 39 00 	movl   $0x39e2,0x4(%esp)
     7d6:	00 
  ...
  if(c != (char*)0xffffffff){
    printf(stdout, "sbrk was able to re-allocate beyond 640K, c %x\n", c);
     ...
     7e8:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     7ed:	c7 44 24 04 dc 48 00 	movl   $0x48dc,0x4(%esp)
     7f4:	00 
  ...
  if(*lastaddr == 99){
    // should be zero
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
     802:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     807:	c7 44 24 04 ac 48 00 	movl   $0x48ac,0x4(%esp)
     80e:	00 
  ...
  if(c != a || sbrk(0) != a + 4096){
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
     81c:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     821:	89 74 24 0c          	mov    %esi,0xc(%esp)
     825:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     829:	c7 44 24 04 84 48 00 	movl   $0x4884,0x4(%esp)
     830:	00 
  ...
  if(c != a - 4096){
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
     ...
     842:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     847:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     84b:	c7 44 24 04 4c 48 00 	movl   $0x484c,0x4(%esp)
     852:	00 
  ...
  if(c == (char*)0xffffffff){
    printf(stdout, "sbrk could not deallocate\n");
     860:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     865:	c7 44 24 04 e5 3a 00 	movl   $0x3ae5,0x4(%esp)
     86c:	00 
  ...
  *lastaddr = 99;
  ...
  if(c != (char*)0xffffffff){
    printf(stdout, "sbrk allocated more than 640K, c %x\n", c);
     ...
     87e:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     883:	c7 44 24 04 24 48 00 	movl   $0x4824,0x4(%esp)
     88a:	00 
  ...
  if(p != a){
    printf(stdout, "sbrk test failed 640K test, p %x a %x\n", p, a);
     ...
     89c:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     8a1:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
     8a5:	c7 44 24 04 fc 47 00 	movl   $0x47fc,0x4(%esp)
     8ac:	00 
  ...
  if(c != a + 1){
    printf(stdout, "sbrk test failed post-fork\n");
     8ba:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     8bf:	c7 44 24 04 c9 3a 00 	movl   $0x3ac9,0x4(%esp)
     8c6:	00 
  ...
  if(pid < 0){
    printf(stdout, "sbrk test fork failed\n");
     8d4:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
     8d9:	c7 44 24 04 b2 3a 00 	movl   $0x3ab2,0x4(%esp)
     8e0:	00 
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     8f9:	c7 44 24 04 51 3b 00 	movl   $0x3b51,0x4(%esp)
     900:	00 
     ...
     912:	85 c0                	test   %eax,%eax
{
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     958:	00 
     959:	c7 44 24 04 55 40 00 	movl   $0x4055,0x4(%esp)
     960:	00 
     ...
     96e:	c7 44 24 04 5b 3b 00 	movl   $0x3b5b,0x4(%esp)
     975:	00 
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     9ba:	c7 44 24 04 6f 3b 00 	movl   $0x3b6f,0x4(%esp)
     9c1:	00 
  ...
  printf(1, "kill... ");
     9e1:	c7 44 24 04 82 3b 00 	movl   $0x3b82,0x4(%esp)
     9e8:	00 
  ...
  printf(1, "wait... ");
     a0d:	c7 44 24 04 8b 3b 00 	movl   $0x3b8b,0x4(%esp)
     a14:	00 
  ...
  printf(1, "preempt ok\n");
     a35:	c7 44 24 04 94 3b 00 	movl   $0x3b94,0x4(%esp)
     a3c:	00 
...
pipe1(void)
{
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
      for(i = 0; i < n; i++){
        if((buf[i] & 0xff) != (seq++ & 0xff)){
          printf(1, "pipe1 oops 2\n");
     ae6:	c7 44 24 04 ae 3b 00 	movl   $0x3bae,0x4(%esp)
     aed:	00 
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     b1b:	88 90 c0 75 00 00    	mov    %dl,0x75c0(%eax)
  pid = fork();
  seq = 0;
  if(pid == 0){
    close(fds[0]);
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     b3b:	00 
     b3c:	c7 44 24 04 c0 75 00 	movl   $0x75c0,0x4(%esp)
     b43:	00 
  ...
  if(pid == 0){
    ...
    if(total != 5 * 1033)
     ...
     b71:	c7 44 24 04 bc 3b 00 	movl   $0x3bbc,0x4(%esp)
     b78:	00 
  ...
  printf(1, "pipe1 ok\n");
     b95:	c7 44 24 04 d3 3b 00 	movl   $0x3bd3,0x4(%esp)
     b9c:	00 
    ...
    for(n = 0; n < 5; n++){
      ...
      if(write(fds[1], buf, 1033) != 1033){
        printf(1, "pipe1 oops 1\n");
     bae:	c7 44 24 04 a0 3b 00 	movl   $0x3ba0,0x4(%esp)
     bb5:	00 
     ...
     bc2:	e8 31 28 00 00       	call   33f8 <exit>
{
  ...
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
     bc7:	c7 44 24 04 19 3b 00 	movl   $0x3b19,0x4(%esp)
     bce:	00 
    ...
    printf(1, "fork() failed\n");
     be0:	c7 44 24 04 dd 3b 00 	movl   $0x3bdd,0x4(%esp)
     be7:	00 
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
     c06:	c7 44 24 04 ec 3b 00 	movl   $0x3bec,0x4(%esp)
     c0d:	00 
     c0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c15:	e8 26 29 00 00       	call   3540 <printf>

  if(mkdir("12345678901234") != 0){
     c1a:	c7 04 24 27 3c 00 00 	movl   $0x3c27,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
     c2e:	c7 04 24 0c 49 00 00 	movl   $0x490c,(%esp)
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
     ...
     c49:	00 
     c4a:	c7 04 24 5c 49 00 00 	movl   $0x495c,(%esp)
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
     ...
     c6d:	00 
     c6e:	c7 04 24 cc 49 00 00 	movl   $0x49cc,(%esp)
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
     c8a:	c7 04 24 18 3c 00 00 	movl   $0x3c18,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
     c9a:	c7 04 24 68 4a 00 00 	movl   $0x4a68,(%esp)
  ...
  printf(1, "fourteen ok\n");
     caa:	c7 44 24 04 36 3c 00 	movl   $0x3c36,0x4(%esp)
     cb1:	00 
  ...
  if(mkdir("12345678901234") != 0){
    printf(1, "mkdir 12345678901234 failed\n");
     cc0:	c7 44 24 04 fb 3b 00 	movl   $0x3bfb,0x4(%esp)
     cc7:	00 
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
     cd9:	c7 44 24 04 88 4a 00 	movl   $0x4a88,0x4(%esp)
     ce0:	00 
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
     cf2:	c7 44 24 04 38 4a 00 	movl   $0x4a38,0x4(%esp)
     cf9:	00 
  ...
  if(fd < 0){
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
     d0b:	c7 44 24 04 fc 49 00 	movl   $0x49fc,0x4(%esp)
     d12:	00 
  ...
  if(fd < 0){
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
     d24:	c7 44 24 04 8c 49 00 	movl   $0x498c,0x4(%esp)
     d2b:	00 
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
     d3d:	c7 44 24 04 2c 49 00 	movl   $0x492c,0x4(%esp)
     d44:	00 
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
     d69:	c7 44 24 04 43 3c 00 	movl   $0x3c43,0x4(%esp)
     d70:	00 
  ...
  for(i = 0; i < 50 + 1; i++){
    if(mkdir("irefd") != 0){
     d80:	c7 04 24 54 3c 00 00 	movl   $0x3c54,(%esp)
    ...
    if(chdir("irefd") != 0){
     d94:	c7 04 24 54 3c 00 00 	movl   $0x3c54,(%esp)
    ...
    mkdir("");
     da8:	c7 04 24 0f 47 00 00 	movl   $0x470f,(%esp)
     daf:	e8 ac 26 00 00       	call   3460 <mkdir>
    link("README", "");
     db4:	c7 44 24 04 0f 47 00 	movl   $0x470f,0x4(%esp)
     dbb:	00 
     dbc:	c7 04 24 82 3c 00 00 	movl   $0x3c82,(%esp)
     dc3:	e8 90 26 00 00       	call   3458 <link>
    fd = open("", O_CREATE);
     dc8:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
     dcf:	00 
     dd0:	c7 04 24 0f 47 00 00 	movl   $0x470f,(%esp)
    ...
    fd = open("xx", O_CREATE);
     ...
     def:	00 
     df0:	c7 04 24 54 40 00 00 	movl   $0x4054,(%esp)
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    if(fd >= 0)
      close(fd);
    unlink("xx");
     e0b:	c7 04 24 54 40 00 00 	movl   $0x4054,(%esp)
  ...
  chdir("/");
     e20:	c7 04 24 89 3c 00 00 	movl   $0x3c89,(%esp)
     e27:	e8 3c 26 00 00       	call   3468 <chdir>
  printf(1, "empty file name OK\n");
     e2c:	c7 44 24 04 8b 3c 00 	movl   $0x3c8b,0x4(%esp)
     e33:	00 
  ...
  for(i = 0; i < 50 + 1; i++){
    if(mkdir("irefd") != 0){
      printf(1, "mkdir irefd failed\n");
     e46:	c7 44 24 04 5a 3c 00 	movl   $0x3c5a,0x4(%esp)
     e4d:	00 
    ...
    if(chdir("irefd") != 0){
      printf(1, "chdir irefd failed\n");
     e5f:	c7 44 24 04 6e 3c 00 	movl   $0x3c6e,0x4(%esp)
     e66:	00 
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
     e87:	c7 44 24 04 9f 3c 00 	movl   $0x3c9f,0x4(%esp)
     e8e:	00 
  ...
  fd = open("dirfile", O_CREATE);
     ...
     ea2:	00 
     ea3:	c7 04 24 ac 3c 00 00 	movl   $0x3cac,(%esp)
  ...
  if(chdir("dirfile") == 0){
     ebf:	c7 04 24 ac 3c 00 00 	movl   $0x3cac,(%esp)
  ...
  fd = open("dirfile/xx", 0);
     ...
     eda:	00 
     edb:	c7 04 24 e5 3c 00 00 	movl   $0x3ce5,(%esp)
  ...
  fd = open("dirfile/xx", O_CREATE);
     ...
     ef6:	00 
     ef7:	c7 04 24 e5 3c 00 00 	movl   $0x3ce5,(%esp)
  ...
  if(mkdir("dirfile/xx") == 0){
     f0b:	c7 04 24 e5 3c 00 00 	movl   $0x3ce5,(%esp)
  ...
  if(unlink("dirfile/xx") == 0){
     f1f:	c7 04 24 e5 3c 00 00 	movl   $0x3ce5,(%esp)
  ...
  if(link("README", "dirfile/xx") == 0){
     f33:	c7 44 24 04 e5 3c 00 	movl   $0x3ce5,0x4(%esp)
     f3a:	00 
     f3b:	c7 04 24 82 3c 00 00 	movl   $0x3c82,(%esp)
  ...
  if(unlink("dirfile") != 0){
     f4f:	c7 04 24 ac 3c 00 00 	movl   $0x3cac,(%esp)
  ...
  fd = open(".", O_RDWR);
     ...
     f6a:	00 
     f6b:	c7 04 24 72 3f 00 00 	movl   $0x3f72,(%esp)
  ...
  fd = open(".", 0);
     ...
     f86:	00 
     f87:	c7 04 24 72 3f 00 00 	movl   $0x3f72,(%esp)
     f8e:	e8 a5 24 00 00       	call   3438 <open>
  if(write(fd, "x", 1) > 0){
     f93:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
     f9a:	00 
     f9b:	c7 44 24 04 55 40 00 	movl   $0x4055,0x4(%esp)
     fa2:	00 
  fd = open(".", O_RDWR);
  if(fd >= 0){
    printf(1, "open . for writing succeeded!\n");
  ...
  printf(1, "dir vs file OK\n");
     fb9:	c7 44 24 04 75 3d 00 	movl   $0x3d75,0x4(%esp)
     fc0:	00 
  ...
  if(fd >= 0){
    printf(1, "create dirfile/xx succeeded!\n");
     fd3:	c7 44 24 04 f0 3c 00 	movl   $0x3cf0,0x4(%esp)
     fda:	00 
  ...
  if(chdir("dirfile") == 0){
    printf(1, "chdir dirfile succeeded!\n");
     fec:	c7 44 24 04 cb 3c 00 	movl   $0x3ccb,0x4(%esp)
     ff3:	00 
  ...
  if(fd < 0){
    printf(1, "create dirfile failed\n");
    1005:	c7 44 24 04 b4 3c 00 	movl   $0x3cb4,0x4(%esp)
    100c:	00 
  ...
  if(write(fd, "x", 1) > 0){
    printf(1, "write . succeeded!\n");
    101e:	c7 44 24 04 61 3d 00 	movl   $0x3d61,0x4(%esp)
    1025:	00 
  ...
  if(fd >= 0){
    printf(1, "open . for writing succeeded!\n");
    1037:	c7 44 24 04 dc 4a 00 	movl   $0x4adc,0x4(%esp)
    103e:	00 
  ...
  if(unlink("dirfile") != 0){
    printf(1, "unlink dirfile failed!\n");
    1050:	c7 44 24 04 49 3d 00 	movl   $0x3d49,0x4(%esp)
    1057:	00 
  ...
  if(link("README", "dirfile/xx") == 0){
    printf(1, "link to dirfile/xx succeeded!\n");
    1069:	c7 44 24 04 bc 4a 00 	movl   $0x4abc,0x4(%esp)
    1070:	00 
  ...
  if(unlink("dirfile/xx") == 0){
    printf(1, "unlink dirfile/xx succeeded!\n");
    1082:	c7 44 24 04 2b 3d 00 	movl   $0x3d2b,0x4(%esp)
    1089:	00 
  ...
  if(mkdir("dirfile/xx") == 0){
    printf(1, "mkdir dirfile/xx succeeded!\n");
    109b:	c7 44 24 04 0e 3d 00 	movl   $0x3d0e,0x4(%esp)
    10a2:	00 
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    10c6:	c7 44 24 04 85 3d 00 	movl   $0x3d85,0x4(%esp)
    10cd:	00 
    10ce:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10d5:	e8 66 24 00 00       	call   3540 <printf>
  if(mkdir("dots") != 0){
    10da:	c7 04 24 91 3d 00 00 	movl   $0x3d91,(%esp)
  ...
  if(chdir("dots") != 0){
    10ee:	c7 04 24 91 3d 00 00 	movl   $0x3d91,(%esp)
  ...
  if(unlink(".") == 0){
    1102:	c7 04 24 72 3f 00 00 	movl   $0x3f72,(%esp)
  ...
  if(unlink("..") == 0){
    1116:	c7 04 24 71 3f 00 00 	movl   $0x3f71,(%esp)
  ...
  if(chdir("/") != 0){
    112a:	c7 04 24 89 3c 00 00 	movl   $0x3c89,(%esp)
  ...
  if(unlink("dots/.") == 0){
    113e:	c7 04 24 e9 3d 00 00 	movl   $0x3de9,(%esp)
  ...
  if(unlink("dots/..") == 0){
    1152:	c7 04 24 07 3e 00 00 	movl   $0x3e07,(%esp)
  ...
  if(unlink("dots") != 0){
    1162:	c7 04 24 91 3d 00 00 	movl   $0x3d91,(%esp)
  ...
  printf(1, "rmdot ok\n");
    1172:	c7 44 24 04 3c 3e 00 	movl   $0x3e3c,0x4(%esp)
    1179:	00 
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    printf(1, "mkdir dots failed\n");
    1188:	c7 44 24 04 96 3d 00 	movl   $0x3d96,0x4(%esp)
    118f:	00 
  ...
  if(unlink("dots") != 0){
    printf(1, "unlink dots failed!\n");
    11a1:	c7 44 24 04 27 3e 00 	movl   $0x3e27,0x4(%esp)
    11a8:	00 
  ...
  if(unlink("dots/..") == 0){
    printf(1, "unlink dots/.. worked!\n");
    11ba:	c7 44 24 04 0f 3e 00 	movl   $0x3e0f,0x4(%esp)
    11c1:	00 
  ...
  if(unlink("dots/.") == 0){
    printf(1, "unlink dots/. worked!\n");
    11d3:	c7 44 24 04 f0 3d 00 	movl   $0x3df0,0x4(%esp)
    11da:	00 
  ...
  if(chdir("/") != 0){
    printf(1, "chdir / failed\n");
    11ec:	c7 44 24 04 d9 3d 00 	movl   $0x3dd9,0x4(%esp)
    11f3:	00 
  ...
  if(unlink("..") == 0){
    printf(1, "rm .. worked!\n");
    1205:	c7 44 24 04 ca 3d 00 	movl   $0x3dca,0x4(%esp)
    120c:	00 
  ...
  if(unlink(".") == 0){
    printf(1, "rm . worked!\n");
    121e:	c7 44 24 04 bc 3d 00 	movl   $0x3dbc,0x4(%esp)
    1225:	00 
  ...
  if(chdir("dots") != 0){
    printf(1, "chdir dots failed\n");
    1237:	c7 44 24 04 a9 3d 00 	movl   $0x3da9,0x4(%esp)
    123e:	00 
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1257:	c7 44 24 04 46 3e 00 	movl   $0x3e46,0x4(%esp)
    125e:	00 
    125f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1266:	e8 d5 22 00 00       	call   3540 <printf>

  unlink("ff");
    126b:	c7 04 24 cf 3e 00 00 	movl   $0x3ecf,(%esp)
    1272:	e8 d1 21 00 00       	call   3448 <unlink>
  if(mkdir("dd") != 0){
    1277:	c7 04 24 6c 3f 00 00 	movl   $0x3f6c,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1292:	00 
    1293:	c7 04 24 a5 3e 00 00 	movl   $0x3ea5,(%esp)
  ...
  write(fd, "ff", 2);
    ...
    12b0:	00 
    12b1:	c7 44 24 04 cf 3e 00 	movl   $0x3ecf,0x4(%esp)
    12b8:	00 
  ...
  if(unlink("dd") >= 0){
    12c9:	c7 04 24 6c 3f 00 00 	movl   $0x3f6c,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    12dd:	c7 04 24 80 3e 00 00 	movl   $0x3e80,(%esp)
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    12f8:	00 
    12f9:	c7 04 24 a2 3e 00 00 	movl   $0x3ea2,(%esp)
  ...
  write(fd, "FF", 2);
    ...
    1316:	00 
    1317:	c7 44 24 04 c3 3e 00 	movl   $0x3ec3,0x4(%esp)
    131e:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1336:	00 
    1337:	c7 04 24 c6 3e 00 00 	movl   $0x3ec6,(%esp)
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1383:	c7 44 24 04 06 3f 00 	movl   $0x3f06,0x4(%esp)
    138a:	00 
    138b:	c7 04 24 a2 3e 00 00 	movl   $0x3ea2,(%esp)
  ...
  if(unlink("dd/dd/ff") != 0){
    139f:	c7 04 24 a2 3e 00 00 	movl   $0x3ea2,(%esp)
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    13ba:	00 
    13bb:	c7 04 24 a2 3e 00 00 	movl   $0x3ea2,(%esp)
  ...
  if(chdir("dd") != 0){
    13cf:	c7 04 24 6c 3f 00 00 	movl   $0x3f6c,(%esp)
  ...
  if(chdir("dd/../../dd") != 0){
    13e3:	c7 04 24 3a 3f 00 00 	movl   $0x3f3a,(%esp)
  ...
  if(chdir("dd/../../../dd") != 0){
    13f7:	c7 04 24 60 3f 00 00 	movl   $0x3f60,(%esp)
  ...
  if(chdir("./..") != 0){
    140b:	c7 04 24 6f 3f 00 00 	movl   $0x3f6f,(%esp)
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1426:	00 
    1427:	c7 04 24 06 3f 00 00 	movl   $0x3f06,(%esp)
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    146d:	00 
    146e:	c7 04 24 a2 3e 00 00 	movl   $0x3ea2,(%esp)
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1489:	00 
    148a:	c7 04 24 ba 3f 00 00 	movl   $0x3fba,(%esp)
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    14a5:	00 
    14a6:	c7 04 24 df 3f 00 00 	movl   $0x3fdf,(%esp)
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    14c1:	00 
    14c2:	c7 04 24 6c 3f 00 00 	movl   $0x3f6c,(%esp)
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    14dd:	00 
    14de:	c7 04 24 6c 3f 00 00 	movl   $0x3f6c,(%esp)
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    14f9:	00 
    14fa:	c7 04 24 6c 3f 00 00 	movl   $0x3f6c,(%esp)
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    150e:	c7 44 24 04 4e 40 00 	movl   $0x404e,0x4(%esp)
    1515:	00 
    1516:	c7 04 24 ba 3f 00 00 	movl   $0x3fba,(%esp)
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    152a:	c7 44 24 04 4e 40 00 	movl   $0x404e,0x4(%esp)
    1531:	00 
    1532:	c7 04 24 df 3f 00 00 	movl   $0x3fdf,(%esp)
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    1546:	c7 44 24 04 06 3f 00 	movl   $0x3f06,0x4(%esp)
    154d:	00 
    154e:	c7 04 24 a5 3e 00 00 	movl   $0x3ea5,(%esp)
  ...
  if(mkdir("dd/ff/ff") == 0){
    1562:	c7 04 24 ba 3f 00 00 	movl   $0x3fba,(%esp)
  ...
  if(mkdir("dd/xx/ff") == 0){
    1576:	c7 04 24 df 3f 00 00 	movl   $0x3fdf,(%esp)
  ...
  if(mkdir("dd/dd/ffff") == 0){
    158a:	c7 04 24 06 3f 00 00 	movl   $0x3f06,(%esp)
  ...
  if(unlink("dd/xx/ff") == 0){
    159e:	c7 04 24 df 3f 00 00 	movl   $0x3fdf,(%esp)
  ...
  if(unlink("dd/ff/ff") == 0){
    15b2:	c7 04 24 ba 3f 00 00 	movl   $0x3fba,(%esp)
  ...
  if(chdir("dd/ff") == 0){
    15c6:	c7 04 24 a5 3e 00 00 	movl   $0x3ea5,(%esp)
  ...
  if(chdir("dd/xx") == 0){
    15da:	c7 04 24 51 40 00 00 	movl   $0x4051,(%esp)
  ...
  if(unlink("dd/dd/ffff") != 0){
    15ee:	c7 04 24 06 3f 00 00 	movl   $0x3f06,(%esp)
  ...
  if(unlink("dd/ff") != 0){
    1602:	c7 04 24 a5 3e 00 00 	movl   $0x3ea5,(%esp)
  ...
  if(unlink("dd") == 0){
    1616:	c7 04 24 6c 3f 00 00 	movl   $0x3f6c,(%esp)
  ...
  if(unlink("dd/dd") < 0){
    162a:	c7 04 24 81 3e 00 00 	movl   $0x3e81,(%esp)
  ...
  if(unlink("dd") < 0){
    163e:	c7 04 24 6c 3f 00 00 	movl   $0x3f6c,(%esp)
  ...
  printf(1, "subdir ok\n");
    1652:	c7 44 24 04 4e 41 00 	movl   $0x414e,0x4(%esp)
    1659:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    printf(1, "dd/dd/../ff wrong content\n");
    166c:	c7 44 24 04 eb 3e 00 	movl   $0x3eeb,0x4(%esp)
    1673:	00 
  ...
  if(chdir("dd/../../../dd") != 0){
    printf(1, "chdir dd/../../dd failed\n");
    1685:	c7 44 24 04 46 3f 00 	movl   $0x3f46,0x4(%esp)
    168c:	00 
  ...
  if(unlink("dd/dd/ffff") != 0){
    printf(1, "unlink dd/dd/ff failed\n");
    169e:	c7 44 24 04 11 3f 00 	movl   $0x3f11,0x4(%esp)
    16a5:	00 
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    printf(1, "create dd/ff/ff succeeded!\n");
    16b7:	c7 44 24 04 c3 3f 00 	movl   $0x3fc3,0x4(%esp)
    16be:	00 
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    16d0:	c7 44 24 04 6c 4b 00 	movl   $0x4b6c,0x4(%esp)
    16d7:	00 
  ...
  if(mkdir("dd/ff/ff") == 0){
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    16e9:	c7 44 24 04 57 40 00 	movl   $0x4057,0x4(%esp)
    16f0:	00 
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    1702:	c7 44 24 04 dc 4b 00 	movl   $0x4bdc,0x4(%esp)
    1709:	00 
  ...
  if(fd < 0){
    printf(1, "open dd/dd/../ff failed\n");
    171b:	c7 44 24 04 d2 3e 00 	movl   $0x3ed2,0x4(%esp)
    1722:	00 
  ...
  if(fd < 0){
    printf(1, "create dd/dd/ff failed\n");
    1734:	c7 44 24 04 ab 3e 00 	movl   $0x3eab,0x4(%esp)
    173b:	00 
  ...
  if(chdir("./..") != 0){
    printf(1, "chdir ./.. failed\n");
    174d:	c7 44 24 04 74 3f 00 	movl   $0x3f74,0x4(%esp)
    1754:	00 
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    1766:	c7 44 24 04 24 4b 00 	movl   $0x4b24,0x4(%esp)
    176d:	00 
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    177f:	c7 44 24 04 b8 4b 00 	movl   $0x4bb8,0x4(%esp)
    1786:	00 
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    1798:	c7 44 24 04 94 4b 00 	movl   $0x4b94,0x4(%esp)
    179f:	00 
  ...
  if(open("dd", O_WRONLY) >= 0){
    printf(1, "open dd wronly succeeded!\n");
    17b1:	c7 44 24 04 33 40 00 	movl   $0x4033,0x4(%esp)
    17b8:	00 
  ...
  if(open("dd", O_RDWR) >= 0){
    printf(1, "open dd rdwr succeeded!\n");
    17ca:	c7 44 24 04 1a 40 00 	movl   $0x401a,0x4(%esp)
    17d1:	00 
  ...
  if(open("dd", O_CREATE) >= 0){
    printf(1, "create dd succeeded!\n");
    17e3:	c7 44 24 04 04 40 00 	movl   $0x4004,0x4(%esp)
    17ea:	00 
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    printf(1, "create dd/xx/ff succeeded!\n");
    17fc:	c7 44 24 04 e8 3f 00 	movl   $0x3fe8,0x4(%esp)
    1803:	00 
  ...
  if(chdir("dd") != 0){
    printf(1, "chdir dd failed\n");
    1815:	c7 44 24 04 29 3f 00 	movl   $0x3f29,0x4(%esp)
    181c:	00 
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    182e:	c7 44 24 04 48 4b 00 	movl   $0x4b48,0x4(%esp)
    1835:	00 
  ...
  if(mkdir("/dd/dd") != 0){
    printf(1, "subdir mkdir dd/dd failed\n");
    1847:	c7 44 24 04 87 3e 00 	movl   $0x3e87,0x4(%esp)
    184e:	00 
  ...
  if(unlink("dd") >= 0){
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    1860:	c7 44 24 04 fc 4a 00 	movl   $0x4afc,0x4(%esp)
    1867:	00 
  ...
  if(fd < 0){
    printf(1, "create dd/ff failed\n");
    1879:	c7 44 24 04 6b 3e 00 	movl   $0x3e6b,0x4(%esp)
    1880:	00 
  ...
  if(mkdir("dd") != 0){
    printf(1, "subdir mkdir dd failed\n");
    1892:	c7 44 24 04 53 3e 00 	movl   $0x3e53,0x4(%esp)
    1899:	00 
  ...
  if(unlink("dd") < 0){
    printf(1, "unlink dd failed\n");
    18ab:	c7 44 24 04 3c 41 00 	movl   $0x413c,0x4(%esp)
    18b2:	00 
  ...
  if(unlink("dd/dd") < 0){
    printf(1, "unlink dd/dd failed\n");
    18c4:	c7 44 24 04 27 41 00 	movl   $0x4127,0x4(%esp)
    18cb:	00 
  ...
  if(unlink("dd") == 0){
    printf(1, "unlink non-empty dd succeeded!\n");
    18dd:	c7 44 24 04 00 4c 00 	movl   $0x4c00,0x4(%esp)
    18e4:	00 
  ...
  if(unlink("dd/ff") != 0){
    printf(1, "unlink dd/ff failed\n");
    18f6:	c7 44 24 04 12 41 00 	movl   $0x4112,0x4(%esp)
    18fd:	00 
  ...
  if(chdir("dd/xx") == 0){
    printf(1, "chdir dd/xx succeeded!\n");
    190f:	c7 44 24 04 fa 40 00 	movl   $0x40fa,0x4(%esp)
    1916:	00 
  ...
  if(chdir("dd/ff") == 0){
    printf(1, "chdir dd/ff succeeded!\n");
    1928:	c7 44 24 04 e2 40 00 	movl   $0x40e2,0x4(%esp)
    192f:	00 
  ...
  if(unlink("dd/ff/ff") == 0){
    printf(1, "unlink dd/ff/ff succeeded!\n");
    1941:	c7 44 24 04 c6 40 00 	movl   $0x40c6,0x4(%esp)
    1948:	00 
  ...
  if(unlink("dd/xx/ff") == 0){
    printf(1, "unlink dd/xx/ff succeeded!\n");
    195a:	c7 44 24 04 aa 40 00 	movl   $0x40aa,0x4(%esp)
    1961:	00 
  ...
  if(mkdir("dd/dd/ffff") == 0){
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    1973:	c7 44 24 04 8d 40 00 	movl   $0x408d,0x4(%esp)
    197a:	00 
  ...
  if(mkdir("dd/xx/ff") == 0){
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    198c:	c7 44 24 04 72 40 00 	movl   $0x4072,0x4(%esp)
    1993:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    printf(1, "read dd/dd/ffff wrong len\n");
    19a5:	c7 44 24 04 9f 3f 00 	movl   $0x3f9f,0x4(%esp)
    19ac:	00 
  ...
  if(fd < 0){
    printf(1, "open dd/dd/ffff failed\n");
    19be:	c7 44 24 04 87 3f 00 	movl   $0x3f87,0x4(%esp)
    19c5:	00 
...
bigdir(void)
{
  ...
  for(i = 0; i < 500; i++){
    ...
    1a5a:	c7 04 24 66 41 00 00 	movl   $0x4166,(%esp)
  ...
  unlink("bd");
    1a75:	c7 04 24 66 41 00 00 	movl   $0x4166,(%esp)
  ...
  printf(1, "bigdir ok\n");
    1abd:	c7 44 24 04 a8 41 00 	movl   $0x41a8,0x4(%esp)
    1ac4:	00 
    ...
    if(link("bd", name) != 0){
      printf(1, "bigdir link failed\n");
    1ad8:	c7 44 24 04 7f 41 00 	movl   $0x417f,0x4(%esp)
    1adf:	00 
    ...
    if(unlink(name) != 0){
      printf(1, "bigdir unlink failed");
    1af1:	c7 44 24 04 93 41 00 	movl   $0x4193,0x4(%esp)
    1af8:	00 
  ...
  if(fd < 0){
    printf(1, "bigdir create failed\n");
    1b0a:	c7 44 24 04 69 41 00 	movl   $0x4169,0x4(%esp)
    1b11:	00 
...
linktest(void)
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1b88:	00 
    1b89:	c7 44 24 04 d8 41 00 	movl   $0x41d8,0x4(%esp)
    1b90:	00 
  ...
  if(link("lf1", "lf2") < 0){
    1baa:	c7 44 24 04 c1 41 00 	movl   $0x41c1,0x4(%esp)
    1bb1:	00 
    1bb2:	c7 04 24 bd 41 00 00 	movl   $0x41bd,(%esp)
  ...
  unlink("lf1");
    1bc6:	c7 04 24 bd 41 00 00 	movl   $0x41bd,(%esp)
    1bcd:	e8 76 18 00 00       	call   3448 <unlink>

  if(open("lf1", 0) >= 0){
    1bd2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    1bd9:	00 
    1bda:	c7 04 24 bd 41 00 00 	movl   $0x41bd,(%esp)
  ...
  fd = open("lf2", 0);
    ...
    1bf5:	00 
    1bf6:	c7 04 24 c1 41 00 00 	movl   $0x41c1,(%esp)
  ...
  if(link("lf2", "lf2") >= 0){
    1c35:	c7 44 24 04 c1 41 00 	movl   $0x41c1,0x4(%esp)
    1c3c:	00 
    1c3d:	c7 04 24 c1 41 00 00 	movl   $0x41c1,(%esp)
  ...
  unlink("lf2");
    1c51:	c7 04 24 c1 41 00 00 	movl   $0x41c1,(%esp)
    1c58:	e8 eb 17 00 00       	call   3448 <unlink>
  if(link("lf2", "lf1") >= 0){
    1c5d:	c7 44 24 04 bd 41 00 	movl   $0x41bd,0x4(%esp)
    1c64:	00 
    1c65:	c7 04 24 c1 41 00 00 	movl   $0x41c1,(%esp)
  ...
  if(link(".", "lf1") >= 0){
    1c75:	c7 44 24 04 bd 41 00 	movl   $0x41bd,0x4(%esp)
    1c7c:	00 
    1c7d:	c7 04 24 72 3f 00 00 	movl   $0x3f72,(%esp)
  ...
  printf(1, "linktest ok\n");
    1c8d:	c7 44 24 04 61 42 00 	movl   $0x4261,0x4(%esp)
    1c94:	00 
  ...
  if(fd < 0){
    printf(1, "create lf1 failed\n");
    1ca7:	c7 44 24 04 c5 41 00 	movl   $0x41c5,0x4(%esp)
    1cae:	00 
  ...
  if(link(".", "lf1") >= 0){
    printf(1, "link . lf1 succeeded! oops\n");
    1cc0:	c7 44 24 04 45 42 00 	movl   $0x4245,0x4(%esp)
    1cc7:	00 
  ...
  if(link("lf2", "lf1") >= 0){
    printf(1, "link non-existant succeeded! oops\n");
    1cd9:	c7 44 24 04 48 4c 00 	movl   $0x4c48,0x4(%esp)
    1ce0:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    printf(1, "link lf2 lf2 succeeded! oops\n");
    1cf2:	c7 44 24 04 27 42 00 	movl   $0x4227,0x4(%esp)
    1cf9:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    printf(1, "read lf2 failed\n");
    1d0b:	c7 44 24 04 16 42 00 	movl   $0x4216,0x4(%esp)
    1d12:	00 
  ...
  if(fd < 0){
    printf(1, "open lf2 failed\n");
    1d24:	c7 44 24 04 05 42 00 	movl   $0x4205,0x4(%esp)
    1d2b:	00 
  ...
  if(open("lf1", 0) >= 0){
    printf(1, "unlinked lf1 but it is still there!\n");
    1d3d:	c7 44 24 04 20 4c 00 	movl   $0x4c20,0x4(%esp)
    1d44:	00 
  ...
  if(link("lf1", "lf2") < 0){
    printf(1, "link lf1 lf2 failed\n");
    1d56:	c7 44 24 04 f0 41 00 	movl   $0x41f0,0x4(%esp)
    1d5d:	00 
  ...
  if(write(fd, "hello", 5) != 5){
    printf(1, "write lf1 failed\n");
    1d6f:	c7 44 24 04 de 41 00 	movl   $0x41de,0x4(%esp)
    1d76:	00 
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1d98:	c7 44 24 04 6e 42 00 	movl   $0x426e,0x4(%esp)
    1d9f:	00 
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1db3:	00 
    1db4:	c7 04 24 7f 42 00 00 	movl   $0x427f,(%esp)
...
unlinkread(void)
{
  ...
  write(fd, "hello", 5);
    ...
    1dd1:	00 
    1dd2:	c7 44 24 04 d8 41 00 	movl   $0x41d8,0x4(%esp)
    1dd9:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1df1:	00 
    1df2:	c7 04 24 7f 42 00 00 	movl   $0x427f,(%esp)
  ...
  if(unlink("unlinkread") != 0){
    1e08:	c7 04 24 7f 42 00 00 	movl   $0x427f,(%esp)
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1e23:	00 
    1e24:	c7 04 24 7f 42 00 00 	movl   $0x427f,(%esp)
    1e2b:	e8 08 16 00 00       	call   3438 <open>
  write(fd1, "yyy", 3);
    1e30:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
    1e37:	00 
    1e38:	c7 44 24 04 d6 42 00 	movl   $0x42d6,0x4(%esp)
    1e3f:	00 
  if(unlink("unlinkread") != 0){
    printf(1, "unlink unlinkread failed\n");
    exit();
  ...
  unlink("unlinkread");
    1ea1:	c7 04 24 7f 42 00 00 	movl   $0x427f,(%esp)
    1ea8:	e8 9b 15 00 00       	call   3448 <unlink>
  printf(1, "unlinkread ok\n");
    1ead:	c7 44 24 04 21 43 00 	movl   $0x4321,0x4(%esp)
    1eb4:	00 
  ...
  if(fd < 0){
    printf(1, "create unlinkread failed\n");
    1ec8:	c7 44 24 04 8a 42 00 	movl   $0x428a,0x4(%esp)
    1ecf:	00 
  ...
  if(write(fd, buf, 10) != 10){
    printf(1, "unlinkread write failed\n");
    1ee1:	c7 44 24 04 08 43 00 	movl   $0x4308,0x4(%esp)
    1ee8:	00 
  ...
  if(buf[0] != 'h'){
    printf(1, "unlinkread wrong data\n");
    1efa:	c7 44 24 04 f1 42 00 	movl   $0x42f1,0x4(%esp)
    1f01:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    printf(1, "unlinkread read failed");
    1f13:	c7 44 24 04 da 42 00 	movl   $0x42da,0x4(%esp)
    1f1a:	00 
  ...
  if(unlink("unlinkread") != 0){
    printf(1, "unlink unlinkread failed\n");
    1f2c:	c7 44 24 04 bc 42 00 	movl   $0x42bc,0x4(%esp)
    1f33:	00 
  ...
  if(fd < 0){
    printf(1, "open unlinkread failed\n");
    1f45:	c7 44 24 04 a4 42 00 	movl   $0x42a4,0x4(%esp)
    1f4c:	00 
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1f69:	c7 44 24 04 30 43 00 	movl   $0x4330,0x4(%esp)
    1f70:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    2000:	c7 44 24 04 43 43 00 	movl   $0x4343,0x4(%esp)
    2007:	00 
  ...
  printf(1, "createdelete ok\n");
    20fb:	c7 44 24 04 52 43 00 	movl   $0x4352,0x4(%esp)
    2102:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    if(fd < 0){
      printf(1, "create failed\n");
    2117:	c7 44 24 04 70 41 00 	movl   $0x4170,0x4(%esp)
    211e:	00 
    ...
    214e:	c7 44 24 04 90 4c 00 	movl   $0x4c90,0x4(%esp)
    2155:	00 
    ...
    216b:	c7 44 24 04 6c 4c 00 	movl   $0x4c6c,0x4(%esp)
    2172:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    2188:	c7 44 24 04 6c 4c 00 	movl   $0x4c6c,0x4(%esp)
    218f:	00 
  ...
  if(pid < 0){
    printf(1, "fork failed\n");
    21a1:	c7 44 24 04 e2 39 00 	movl   $0x39e2,0x4(%esp)
    21a8:	00 
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
    21c6:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    21cb:	c7 44 24 04 63 43 00 	movl   $0x4363,0x4(%esp)
    21d2:	00 
    21d3:	89 04 24             	mov    %eax,(%esp)
    21d6:	e8 65 13 00 00       	call   3540 <printf>

  if(mkdir("dir0") < 0){
    21db:	c7 04 24 6f 43 00 00 	movl   $0x436f,(%esp)
  ...
  if(chdir("dir0") < 0){
    21eb:	c7 04 24 6f 43 00 00 	movl   $0x436f,(%esp)
  ...
  if(chdir("..") < 0){
    21ff:	c7 04 24 71 3f 00 00 	movl   $0x3f71,(%esp)
  ...
  if(unlink("dir0") < 0){
    220f:	c7 04 24 6f 43 00 00 	movl   $0x436f,(%esp)
  ...
  printf(stdout, "mkdir test\n");
    221f:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    2224:	c7 44 24 04 63 43 00 	movl   $0x4363,0x4(%esp)
    222b:	00 
...
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
    printf(stdout, "mkdir failed\n");
    2236:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    223b:	c7 44 24 04 74 43 00 	movl   $0x4374,0x4(%esp)
    2242:	00 
  ...
  if(unlink("dir0") < 0){
    printf(stdout, "unlink dir0 failed\n");
    2250:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    2255:	c7 44 24 04 a6 43 00 	movl   $0x43a6,0x4(%esp)
    225c:	00 
  ...
  if(chdir("..") < 0){
    printf(stdout, "chdir .. failed\n");
    226a:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    226f:	c7 44 24 04 95 43 00 	movl   $0x4395,0x4(%esp)
    2276:	00 
  ...
  if(chdir("dir0") < 0){
    printf(stdout, "chdir dir0 failed\n");
    2284:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    2289:	c7 44 24 04 82 43 00 	movl   $0x4382,0x4(%esp)
    2290:	00 
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
    22ac:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    22b1:	c7 44 24 04 b0 4c 00 	movl   $0x4cb0,0x4(%esp)
    22b8:	00 
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
    232a:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    232f:	c7 44 24 04 d8 4c 00 	movl   $0x4cd8,0x4(%esp)
    2336:	00 
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
    2358:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    235d:	c7 44 24 04 ba 43 00 	movl   $0x43ba,0x4(%esp)
    2364:	00 
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    2374:	00 
    2375:	c7 04 24 34 44 00 00 	movl   $0x4434,(%esp)
    ...
    2381:	85 c0                	test   %eax,%eax
{
  ...
  fd = open("big", O_RDONLY);
    ...
    23d3:	00 
    23d4:	c7 04 24 34 44 00 00 	movl   $0x4434,(%esp)
  ...
  if(unlink("big") < 0){
    243b:	c7 04 24 34 44 00 00 	movl   $0x4434,(%esp)
  ...
  printf(stdout, "big files ok\n");
    244f:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    2454:	c7 44 24 04 5b 44 00 	movl   $0x445b,0x4(%esp)
    245b:	00 
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
      printf(stdout, "error: write big file failed\n", i);
    246b:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    2470:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    2474:	c7 44 24 04 e4 43 00 	movl   $0x43e4,0x4(%esp)
    247b:	00 
    ...
    248d:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    2492:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    2496:	c7 44 24 04 00 4d 00 	movl   $0x4d00,0x4(%esp)
    249d:	00 
    ...
    24af:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    24b4:	c7 44 24 04 38 44 00 	movl   $0x4438,0x4(%esp)
    24bb:	00 
  ...
  for(;;){
    ...
    if(i == 0){
      if(n == MAXFILE - 1){
        printf(stdout, "read only %d blocks from big", n);
    24c9:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    24ce:	c7 44 24 08 8b 00 00 	movl   $0x8b,0x8(%esp)
    24d5:	00 
    24d6:	c7 44 24 04 1b 44 00 	movl   $0x441b,0x4(%esp)
    24dd:	00 
  ...
  if(fd < 0){
    printf(stdout, "error: open big failed!\n");
    24eb:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    24f0:	c7 44 24 04 02 44 00 	movl   $0x4402,0x4(%esp)
    24f7:	00 
  ...
  if(fd < 0){
    printf(stdout, "error: creat big failed!\n");
    2505:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    250a:	c7 44 24 04 ca 43 00 	movl   $0x43ca,0x4(%esp)
    2511:	00 
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
    251f:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    2524:	c7 44 24 04 48 44 00 	movl   $0x4448,0x4(%esp)
    252b:	00 
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
    2548:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    254d:	c7 44 24 04 69 44 00 	movl   $0x4469,0x4(%esp)
    2554:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
    ...
    2564:	00 
    2565:	c7 04 24 7a 44 00 00 	movl   $0x447a,(%esp)
    ...
    2571:	85 c0                	test   %eax,%eax
{
  ...
  if(fd >= 0){
    ...
    257b:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    2580:	31 db                	xor    %ebx,%ebx
    2582:	c7 44 24 04 80 44 00 	movl   $0x4480,0x4(%esp)
    2589:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    259f:	00 
    25a0:	c7 44 24 04 b7 44 00 	movl   $0x44b7,0x4(%esp)
    25a7:	00 
    ...
    25c0:	00 
    25c1:	c7 44 24 04 c2 44 00 	movl   $0x44c2,0x4(%esp)
    25c8:	00 
  ...
  printf(stdout, "writes ok\n");
    25e2:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    25e7:	c7 44 24 04 cd 44 00 	movl   $0x44cd,0x4(%esp)
    25ee:	00 
  ...
  fd = open("small", O_RDONLY);
    ...
    2606:	00 
    2607:	c7 04 24 7a 44 00 00 	movl   $0x447a,(%esp)
  ...
  if(fd >= 0){
    ...
    261d:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    2622:	c7 44 24 04 d8 44 00 	movl   $0x44d8,0x4(%esp)
    2629:	00 
  ...
  if(i == 2000){
    ...
    2655:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    265a:	c7 44 24 04 0c 45 00 	movl   $0x450c,0x4(%esp)
    2661:	00 
  ...
  if(unlink("small") < 0){
    2672:	c7 04 24 7a 44 00 00 	movl   $0x447a,(%esp)
  ...
  printf(stdout, "small file test ok\n");
    2686:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    268b:	c7 44 24 04 34 45 00 	movl   $0x4534,0x4(%esp)
    2692:	00 
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
      printf(stdout, "error: write aa %d new file failed\n", i);
    26a2:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    26a7:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    26ab:	c7 44 24 04 20 4d 00 	movl   $0x4d20,0x4(%esp)
    26b2:	00 
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
      printf(stdout, "error: write bb %d new file failed\n", i);
    26c0:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    26c5:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    26c9:	c7 44 24 04 44 4d 00 	movl   $0x4d44,0x4(%esp)
    26d0:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
    26de:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    26e3:	c7 44 24 04 f1 44 00 	movl   $0x44f1,0x4(%esp)
    26ea:	00 
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
    26f8:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    26fd:	c7 44 24 04 97 42 00 	movl   $0x4297,0x4(%esp)
    2704:	00 
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
    2712:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    2717:	c7 44 24 04 1f 45 00 	movl   $0x451f,0x4(%esp)
    271e:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
    272c:	a1 6c 4e 00 00       	mov    0x4e6c,%eax
    2731:	c7 44 24 04 9b 44 00 	movl   $0x449b,0x4(%esp)
    2738:	00 
...
bigfile(void)
{
  ...
  fd = open("bigfile", 0);
    ...
    27f2:	00 
    27f3:	c7 04 24 64 45 00 00 	movl   $0x4564,(%esp)
  ...
  unlink("bigfile");
    2871:	c7 04 24 64 45 00 00 	movl   $0x4564,(%esp)
    2878:	e8 cb 0b 00 00       	call   3448 <unlink>

  printf(1, "bigfile test ok\n");
    287d:	c7 44 24 04 f3 45 00 	movl   $0x45f3,0x4(%esp)
    2884:	00 
    ...
    if(buf[0] != i/2 || buf[299] != i/2){
      printf(1, "read bigfile wrong data\n");
    2899:	c7 44 24 04 c0 45 00 	movl   $0x45c0,0x4(%esp)
    28a0:	00 
    ...
    if(cc != 300){
      printf(1, "short read bigfile\n");
    28b2:	c7 44 24 04 ac 45 00 	movl   $0x45ac,0x4(%esp)
    28b9:	00 
  ...
  for(i = 0; ; i++){
    ...
    if(cc < 0){
      printf(1, "read bigfile failed\n");
    28cb:	c7 44 24 04 97 45 00 	movl   $0x4597,0x4(%esp)
    28d2:	00 
  ...
  for(i = 0; i < 20; i++){
    ...
    if(write(fd, buf, 600) != 600){
      printf(1, "write bigfile failed\n");
    28e4:	c7 44 24 04 6c 45 00 	movl   $0x456c,0x4(%esp)
    28eb:	00 
  ...
  if(fd < 0){
    printf(1, "cannot open bigfile\n");
    28fd:	c7 44 24 04 82 45 00 	movl   $0x4582,0x4(%esp)
    2904:	00 
  ...
  if(fd < 0){
    printf(1, "cannot create bigfile");
    2916:	c7 44 24 04 56 45 00 	movl   $0x4556,0x4(%esp)
    291d:	00 
  ...
  if(total != 20*600){
    printf(1, "read bigfile wrong total\n");
    292f:	c7 44 24 04 d9 45 00 	movl   $0x45d9,0x4(%esp)
    2936:	00 
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    295b:	c7 44 24 04 04 46 00 	movl   $0x4604,0x4(%esp)
    2962:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    2a04:	c7 04 24 14 46 00 00 	movl   $0x4614,(%esp)
  ...
  for(i = 0; i < 40; i++){
    ...
    2a1f:	c7 04 24 14 46 00 00 	movl   $0x4614,(%esp)
  ...
  fd = open(".", 0);
    ...
    2a5d:	00 
    2a5e:	c7 04 24 72 3f 00 00 	movl   $0x3f72,(%esp)
  ...
  printf(1, "concreate ok\n");
    2b60:	c7 44 24 04 69 46 00 	movl   $0x4669,0x4(%esp)
    2b67:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    if(pid < 0){
      printf(1, "fork failed\n");
    2b7c:	c7 44 24 04 e2 39 00 	movl   $0x39e2,0x4(%esp)
    2b83:	00 
    ...
    2b99:	c7 44 24 04 17 46 00 	movl   $0x4617,0x4(%esp)
    2ba0:	00 
    ...
    2bb9:	c7 44 24 04 33 46 00 	movl   $0x4633,0x4(%esp)
    2bc0:	00 
  ...
  if(n != 40){
    printf(1, "concreate not enough files in directory listing\n");
    2bd2:	c7 44 24 04 68 4d 00 	movl   $0x4d68,0x4(%esp)
    2bd9:	00 
    ...
    2bf2:	c7 44 24 04 4c 46 00 	movl   $0x464c,0x4(%esp)
    2bf9:	00 
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
    2c19:	c7 44 24 04 77 46 00 	movl   $0x4677,0x4(%esp)
    2c20:	00 
    2c21:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c28:	e8 13 09 00 00       	call   3540 <printf>

  unlink("f1");
    2c2d:	c7 04 24 be 41 00 00 	movl   $0x41be,(%esp)
    2c34:	e8 0f 08 00 00       	call   3448 <unlink>
  unlink("f2");
    2c39:	c7 04 24 c2 41 00 00 	movl   $0x41c2,(%esp)
  ...
  fname = pid ? "f1" : "f2";
    2c55:	ba be 41 00 00       	mov    $0x41be,%edx
    2c5a:	b8 c2 41 00 00       	mov    $0x41c2,%eax
  ...
  memset(buf, pid?'p':'c', 512);
    ...
    2c95:	c7 04 24 c0 75 00 00 	movl   $0x75c0,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    2caf:	00 
    2cb0:	c7 44 24 04 c0 75 00 	movl   $0x75c0,0x4(%esp)
    2cb7:	00 
  ...
  if(pid)
    ...
    2cea:	b8 c2 41 00 00       	mov    $0x41c2,%eax
  else
    exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    2d12:	00 
    2d13:	c7 44 24 04 c0 75 00 	movl   $0x75c0,0x4(%esp)
    2d1a:	00 
    ...
    2d33:	0f be b9 c0 75 00 00 	movsbl 0x75c0(%ecx),%edi
  ...
  for(i = 0; i < 2; i++){
    ...
    if(total != 12*500){
      ...
      exit();
    2d67:	b8 be 41 00 00       	mov    $0x41be,%eax
  if(pid)
    wait();
  else
    exit();
  ...
  unlink("f2");
    2d76:	c7 04 24 c2 41 00 00 	movl   $0x41c2,(%esp)
    2d7d:	e8 c6 06 00 00       	call   3448 <unlink>

  printf(1, "twofiles ok\n");
    2d82:	c7 44 24 04 b4 46 00 	movl   $0x46b4,0x4(%esp)
    2d89:	00 
  ...
  if(pid)
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
      for(j = 0; j < n; j++){
        if(buf[j] != (i?'p':'c')){
          printf(1, "wrong char\n");
    2da8:	c7 44 24 04 97 46 00 	movl   $0x4697,0x4(%esp)
    2daf:	00 
  ...
  if(pid < 0){
    printf(1, "fork failed\n");
    2dc1:	c7 44 24 04 e2 39 00 	movl   $0x39e2,0x4(%esp)
    2dc8:	00 
    ...
    2ddb:	c7 44 24 04 a3 46 00 	movl   $0x46a3,0x4(%esp)
    2de2:	00 
  ...
  for(i = 0; i < 12; i++){
    ...
    2df8:	c7 44 24 04 86 46 00 	movl   $0x4686,0x4(%esp)
    2dff:	00 
  ...
  if(fd < 0){
    printf(1, "create failed\n");
    2e11:	c7 44 24 04 70 41 00 	movl   $0x4170,0x4(%esp)
    2e18:	00 
    ...
    2e59:	85 c0                	test   %eax,%eax
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    2ebc:	c7 44 24 04 c8 4d 00 	movl   $0x4dc8,0x4(%esp)
    2ec3:	00 
  ...
  fd = open("sharedfd", 0);
    ...
    2ef3:	00 
    2ef4:	c7 04 24 c1 46 00 00 	movl   $0x46c1,(%esp)
  ...
  unlink("sharedfd");
    2f5c:	c7 04 24 c1 46 00 00 	movl   $0x46c1,(%esp)
  ...
  if(nc == 10000 && np == 10000)
    ...
    2f78:	c7 44 24 04 d7 46 00 	movl   $0x46d7,0x4(%esp)
    2f7f:	00 
  ...
  if(nc == 10000 && np == 10000)
    ...
    printf(1, "sharedfd ok\n");
    2f9c:	c7 44 24 04 ca 46 00 	movl   $0x46ca,0x4(%esp)
    2fa3:	00 
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for writing");
    2fb8:	c7 44 24 04 9c 4d 00 	movl   $0x4d9c,0x4(%esp)
    2fbf:	00 
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for reading\n");
    2fd4:	c7 44 24 04 e8 4d 00 	movl   $0x4de8,0x4(%esp)
    2fdb:	00 
...
mem(void)
{
  ...
  printf(1, "mem test\n");
    2ffb:	c7 44 24 04 ec 46 00 	movl   $0x46ec,0x4(%esp)
    3002:	00 
  ...
  if((pid = fork()) == 0){
    ...
    printf(1, "mem ok\n");
    3068:	c7 44 24 04 10 47 00 	movl   $0x4710,0x4(%esp)
    306f:	00 
    ...
    if(m1 == 0){
      printf(1, "couldn't allocate mem?!!\n");
    3090:	c7 44 24 04 f6 46 00 	movl   $0x46f6,0x4(%esp)
    3097:	00 
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    30c9:	c7 44 24 04 18 47 00 	movl   $0x4718,0x4(%esp)
    30d0:	00 
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3117:	00 
    3118:	c7 04 24 2c 47 00 00 	movl   $0x472c,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    34ca:	f7 f7                	div    %edi
    34cc:	0f b6 92 47 4e 00 00 	movzbl 0x4e47(%edx),%edx
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    3678:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
    367b:	b9 40 4e 00 00       	mov    $0x4e40,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3741:	a1 88 4e 00 00       	mov    0x4e88,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  freep = p;
    3791:	a3 88 4e 00 00       	mov    %eax,0x4e88
}
    3796:	5b                   	pop    %ebx
    3797:	5e                   	pop    %esi
    3798:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    37bd:	a3 88 4e 00 00       	mov    %eax,0x4e88
}
    37c2:	5b                   	pop    %ebx
    37c3:	5e                   	pop    %esi
    37c4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    37dc:	8b 0d 88 4e 00 00    	mov    0x4e88,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    ...
    if(p == freep)
    3810:	3b 05 88 4e 00 00    	cmp    0x4e88,%eax
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    382f:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
    3832:	89 0d 88 4e 00 00    	mov    %ecx,0x4e88
      return (void*)(p + 1);
...
morecore(uint nu)
{
  ...
  return freep;
    3877:	8b 0d 88 4e 00 00    	mov    0x4e88,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    388e:	c7 05 88 4e 00 00 80 	movl   $0x4e80,0x4e88
    3895:	4e 00 00 
    base.s.size = 0;
    3898:	b9 80 4e 00 00       	mov    $0x4e80,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    389d:	c7 05 80 4e 00 00 80 	movl   $0x4e80,0x4e80
    38a4:	4e 00 00 
    base.s.size = 0;
    38a7:	c7 05 84 4e 00 00 00 	movl   $0x0,0x4e84
    38ae:	00 00 00 
