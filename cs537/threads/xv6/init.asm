...
main(void)
{
  ...
  11:	00 
  12:	c7 04 24 67 08 00 00 	movl   $0x867,(%esp)
  ...
  40:	c7 44 24 04 6f 08 00 	movl   $0x86f,0x4(%esp)
  47:	00 
  ...
  74:	74 ca                	je     40 <main+0x40>
      printf(1, "zombie!\n");
  76:	c7 44 24 04 ae 08 00 	movl   $0x8ae,0x4(%esp)
  7d:	00 
  ...
  for(;;){
    ...
    if(pid < 0){
      printf(1, "init: fork failed\n");
  90:	c7 44 24 04 82 08 00 	movl   $0x882,0x4(%esp)
  97:	00 
  ...
  a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(pid == 0){
      exec("sh", argv);
  b0:	c7 44 24 04 d0 08 00 	movl   $0x8d0,0x4(%esp)
  b7:	00 
  b8:	c7 04 24 95 08 00 00 	movl   $0x895,(%esp)
  bf:	e8 bc 02 00 00       	call   380 <exec>
      printf(1, "init: exec sh failed\n");
  c4:	c7 44 24 04 98 08 00 	movl   $0x898,0x4(%esp)
  cb:	00 
...
main(void)
{
  ...
  ec:	00 
  ed:	c7 04 24 67 08 00 00 	movl   $0x867,(%esp)
  f4:	e8 97 02 00 00       	call   390 <mknod>
    open("console", O_RDWR);
  f9:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
 100:	00 
 101:	c7 04 24 67 08 00 00 	movl   $0x867,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41a:	f7 f7                	div    %edi
 41c:	0f b6 92 be 08 00 00 	movzbl 0x8be(%edx),%edx
...
putc(int fd, char c)
{
 ...
 5c8:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 5cb:	b9 b7 08 00 00       	mov    $0x8b7,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 691:	a1 e0 08 00 00       	mov    0x8e0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6df:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6e1:	a3 e0 08 00 00       	mov    %eax,0x8e0
}
 6e6:	5b                   	pop    %ebx
 6e7:	5e                   	pop    %esi
 6e8:	5f                   	pop    %edi
 ...
 70b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 70d:	a3 e0 08 00 00       	mov    %eax,0x8e0
}
 712:	5b                   	pop    %ebx
 713:	5e                   	pop    %esi
 714:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 729:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 72c:	8b 0d e0 08 00 00    	mov    0x8e0,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 75c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 760:	3b 05 e0 08 00 00    	cmp    0x8e0,%eax
 ...
 77f:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 782:	89 0d e0 08 00 00    	mov    %ecx,0x8e0
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 7c2:	e8 c9 fe ff ff       	call   690 <free>
  return freep;
 7c7:	8b 0d e0 08 00 00    	mov    0x8e0,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7dc:	eb a4                	jmp    782 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7de:	c7 05 e0 08 00 00 d8 	movl   $0x8d8,0x8e0
 7e5:	08 00 00 
    base.s.size = 0;
 7e8:	b9 d8 08 00 00       	mov    $0x8d8,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7ed:	c7 05 d8 08 00 00 d8 	movl   $0x8d8,0x8d8
 7f4:	08 00 00 
    base.s.size = 0;
 7f7:	c7 05 dc 08 00 00 00 	movl   $0x0,0x8dc
 7fe:	00 00 00 
...
xchg(volatile uint *addr, uint newval)
{
 ...
 832:	f0 87 02             	lock xchg %eax,(%edx)
//     panic("acquire");
 ...
 837:	75 f7                	jne    830 <lock_acquire+0x10>
    ;
...
lock_release(struct lock_t *lock)
{
 ...
 848:	f0 87 02             	lock xchg %eax,(%edx)
